...
- **Proteger datos del titular de la tarjeta**: No almacene nunca los datos del titular de la tarjeta en Adobe Commerce. Si se requiere almacenamiento, utilice métodos cifrados y tokenizados para protegerlo.
