...
* **ACSD-63572** (para Adobe Commerce y el Magento Open Source >=2.4.5 &lt;2.4.8): corrige el problema en el que las tablas temporales del indizador `CatalogRule` no se limpian si finaliza el proceso del indizador.
