...
La revisión ACSD-55112 corrige el problema en el cual se puede hacer clic en el botón [!UICONTROL Submit Review] varias veces sin validación de [!DNL Google reCAPTCHA v3]. Esta revisión está disponible cuando está instalado [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.42. El ID del parche es ACSD-55112. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.7.
