...
La revisión ACSD-54890 corrige el problema en el cual `aggregate_sales_report_bestsellers_data` causa [!DNL MySQL] errores debido a que `/tmpdisk` está sin espacio. Esta revisión está disponible cuando está instalado [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.42. El ID del parche es ACSD-54890. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.7.
