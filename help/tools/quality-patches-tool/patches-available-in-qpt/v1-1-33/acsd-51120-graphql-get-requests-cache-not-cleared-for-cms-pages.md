...
El parche ACSD-51120 corrige el problema de que la caché de solicitudes de GraphQL GET no se borra para las páginas de CMS que contienen bloques de CMS que se actualizan mediante una actualización de ensayo. Esta revisión está disponible cuando está instalado [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.33. El ID del parche es ACSD-51120. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.7.
...
1. Recupere la página de CMS utilizando la consulta de GraphQL determinada utilizando una petición GET:
...
1. Vuelva a recuperar la página de CMS con la consulta de GraphQL determinada mediante una petición GET.
