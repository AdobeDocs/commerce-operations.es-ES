---
title: 'ACSD-60631: La consulta de GraphQL devuelve un error cuando el mismo producto se asigna a varios productos configurables'
...
El parche ACSD-60631 corrige el problema en el que una consulta de GraphQL devuelve un error cuando el mismo producto se asigna a varios productos configurables. Esta revisión está disponible cuando está instalado [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.51. El ID del parche es ACSD-60631. Este problema está programado para solucionarse en Adobe Commerce 2.4.8.
