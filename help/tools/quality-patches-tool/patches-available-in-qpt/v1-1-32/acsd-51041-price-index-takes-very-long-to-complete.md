...
El parche ACSD-51041 soluciona el problema en el que el índice de precios tarda mucho tiempo en completarse con un conjunto de productos muy grande. Esta revisión está disponible cuando está instalado [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.32. El ID del parche es ACSD-51041. Tenga en cuenta que el problema se solucionó en Adobe Commerce 2.4.6.
