...
1. **ACSD-68490**: corrige el problema donde el botón **[!UICONTROL Add New Attribute]** es visible para un usuario administrador restringido durante la creación configurable del producto.
