...
1. **[ACP2E-4402](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-79/acp2e-4402.md)**: corrige el problema por el cual los productos creados como deshabilitados no se volvieron a agregar a los resultados de [!UICONTROL Target Rule] relacionados después de habilitarse.
...
1. **[ACP2E-4706](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-79/acp2e-4706.md)**: corrige el problema por el que el indizador [!UICONTROL Target Rule] omitió los productos no habilitados en el ámbito de administración.
