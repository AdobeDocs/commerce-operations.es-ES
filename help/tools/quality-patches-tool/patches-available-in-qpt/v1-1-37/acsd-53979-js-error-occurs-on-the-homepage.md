...
El parche ACSD-53979 corrige el problema en el que se produce un error de JavaScript en la página de inicio si el mensaje de bienvenida contiene una comilla simple. Esta revisión está disponible cuando está instalado [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.37. El ID del parche es ACSD-53979. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.7.
