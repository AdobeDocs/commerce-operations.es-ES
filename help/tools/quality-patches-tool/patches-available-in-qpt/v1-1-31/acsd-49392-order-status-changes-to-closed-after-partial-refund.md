...
>[!NOTE]
>
>El parche ACSD-49392 se reemplazó con el parche [ACSD-57003](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-46/acsd-57003-order-status-changed-to-complete-instead-of-processing.md) para las versiones 2.4.6-p7 a 2.4.6-p10.
