...
El parche de ACSD-49773 corrige el problema en el que la exportación del producto falla cuando AWS S3 se utiliza como almacenamiento remoto. Esta revisión está disponible cuando está instalado [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.29. El ID del parche es ACSD-49773. Tenga en cuenta que el problema se solucionó en Adobe Commerce 2.4.6.
