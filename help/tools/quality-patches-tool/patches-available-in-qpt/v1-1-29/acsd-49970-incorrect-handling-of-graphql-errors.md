...
La revisión ACSD-49970 corrige el problema en el que hay un control incorrecto de los errores de GraphQL cuando se activa *[!UICONTROL New Relic Reporting]*. Esta revisión está disponible cuando está instalado [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.29. El ID del parche es ACSD-49970. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.7.
