...
El parche ACSD-49960 corrige el problema de que el filtrado por fecha no funciona para la cuadrícula de pedidos del cliente. Esta revisión está disponible cuando está instalado [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.29. El ID del parche es ACSD-49960. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.7.
