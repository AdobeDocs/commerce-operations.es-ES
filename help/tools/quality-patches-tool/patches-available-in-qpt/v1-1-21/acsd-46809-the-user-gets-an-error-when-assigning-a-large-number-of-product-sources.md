---
title: 'ACSD-46809: El usuario recibe un error al asignar un gran número de orígenes de producto'
...
El parche ACSD-46809 corrige el problema en el que el usuario recibe un error al asignar un gran número de fuentes de productos. Esta revisión está disponible cuando está instalado [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.21. El ID del parche es ACSD-46809. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.6.
