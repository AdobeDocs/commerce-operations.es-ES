...
El parche ACSD-47076 corrige el problema que impide que se reproduzcan vídeos de [!DNL Vimeo] en la tienda. Esta revisión está disponible cuando está instalado [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.21. El ID del parche es ACSD-47076. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.6.
