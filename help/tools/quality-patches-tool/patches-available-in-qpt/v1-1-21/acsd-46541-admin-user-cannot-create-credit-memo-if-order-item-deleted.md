...
El parche ACSD-46541 corrige el problema en el que un usuario administrador no puede crear un abono si se elimina un elemento de pedido. Esta revisión está disponible cuando está instalado [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.21. El ID del parche es ACSD-46541. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.6.
