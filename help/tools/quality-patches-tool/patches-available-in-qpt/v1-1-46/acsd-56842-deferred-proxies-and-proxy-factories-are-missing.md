...
El parche ACSD-56842 corrige el problema en el que los proxies diferidos y las fábricas de proxy no están después de ejecutar `setup:di:compile`. Esta revisión está disponible cuando está instalado [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.46. El ID del parche es ACSD-56842. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.7.
