...
El parche ACSD-57846 corrige el problema por el que el filtrado de productos para el precio desde cero conduce a una solicitud mal formada para [!DNL OpenSearch] y no devuelve ningún resultado. Esta revisión está disponible cuando está instalado [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.49. El ID del parche es ACSD-57846. Tenga en cuenta que el problema se solucionó en Adobe Commerce 2.4.7.
