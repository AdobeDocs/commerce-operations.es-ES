...
El parche ACSD-57643 soluciona el problema de los productos con opciones personalizadas que se añaden incorrectamente al carro de compras mediante GraphQL. Esta revisión está disponible cuando está instalado [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.49. El ID del parche es ACSD-57643. Tenga en cuenta que el problema se solucionó en Adobe Commerce 2.4.7.
