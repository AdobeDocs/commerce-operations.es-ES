...
El parche ACSD-46146 soluciona el problema de enviar dos correos electrónicos de confirmación de pedido después de realizar un pedido del administrador. Este parche está disponible cuando está instalada la [Herramienta Parches de calidad (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.18. El ID del parche es ACSD-46146. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.6.
