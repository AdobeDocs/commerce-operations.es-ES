...
El parche MDVA-44660 corrige el problema en el que el carácter de acento grave (\`) no se puede usar para el nombre de un cliente. Este parche está disponible cuando está instalada la [Herramienta Parches de calidad (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.15. El ID del parche es MDVA-44660. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.5.
