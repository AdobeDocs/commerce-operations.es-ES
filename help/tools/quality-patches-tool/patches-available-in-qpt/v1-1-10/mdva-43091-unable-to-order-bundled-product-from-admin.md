...
El parche MDVA-43091 resuelve el problema en el que los usuarios no pueden solicitar el producto empaquetado al administrador de Commerce. Este parche está disponible cuando está instalada la [Herramienta Parches de calidad (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.10. El ID del parche es MDVA-43091. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.4.
