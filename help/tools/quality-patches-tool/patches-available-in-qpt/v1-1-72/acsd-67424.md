---
title: 'ACSD-67424: el valor "updated_at" en la respuesta de la API REST "GET /carts/search" no coincide con el valor en [!UICONTROL Admin Panel] para [!UICONTROL Negotiable Quotes]'
