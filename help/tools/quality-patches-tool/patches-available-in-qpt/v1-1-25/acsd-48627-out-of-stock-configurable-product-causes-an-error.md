...
El parche ACSD-48627 corrige el problema en el que el producto configurable sin existencias provoca un error al enviar una solicitud de GraphQL para obtener los detalles del carro de compras. Esta revisión está disponible cuando está instalado [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.25. El ID del parche es ACSD-48627. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.6.
