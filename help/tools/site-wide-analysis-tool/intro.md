...
- **[[!DNL Managed Alerts]](/help/tools/managed-alerts-for-adobe-commerce/managed-alerts-for-magento-commerce.md)**: supervise las métricas clave (CPU, rendimiento de la aplicación, disco, memoria y estado de la base de datos) y proporcione pasos claros de solución de problemas para ayudar a los comerciantes a adelantarse a los problemas y evitar el tiempo de inactividad.
