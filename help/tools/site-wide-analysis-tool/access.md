...
>[!NOTE]
>
>Para acceder a la herramienta de análisis de todo el sitio (SWAT), los usuarios deben tener los permisos necesarios en la administración de Adobe Commerce. No se admite el acceso directo a la dirección URL de SWAT, incluidos los vínculos con marcadores.
