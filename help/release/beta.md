...
Para obtener más información, consulte [Clasificación de atributos](https://experienceleague.adobe.com/en/docs/commerce/optimizer/merchandising/rules/add#attribute-ranking) en la guía de reglas de comercialización.
