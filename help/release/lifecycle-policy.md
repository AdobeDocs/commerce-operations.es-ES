...
| Versión | Disponibilidad general | Fin de la compatibilidad con software<sup>1</sup> | Versión de PHP dependiente | Versión de MariaDB dependiente |
|----------------------|----------------------|-------------------------------------|-----------------------|------------------------------|
...
>- <sup>3</sup> a partir de la revisión de seguridad 2.4.4-p9.
