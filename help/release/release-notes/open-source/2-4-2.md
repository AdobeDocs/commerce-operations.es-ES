...
* La capacidad de configurar una instalación para utilizar una base de datos dividida ha quedado obsoleta en esta versión. Vea la [obsolescencia de la funcionalidad de la base de datos dividida en la publicación de DevBlog en Magento Open Source](https://community.magento.com/t5/Magento-DevBlog/Deprecation-of-Split-Database-in-Magento-Commerce/ba-p/465187).
...
* La consulta `products` ahora devuelve los resultados esperados cuando el `category_id`  el filtro se ha especificado con la palabra clave `in`. [GitHub-30349](https://github.com/magento/magento2/issues/30349)
