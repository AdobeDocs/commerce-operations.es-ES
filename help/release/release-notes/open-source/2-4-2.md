...
* La aplicación ya no genera un error cuando intenta cambiar `backend-frontname` con el contenedor `ssh` después de instalar el Magento Open Source. [GitHub-26762](https://github.com/magento/magento2/issues/26762)
...
Puede instalar el Magento Open Source 2.4.2 con [Composer](../../../installation/composer.md).
