...
description: Obtenga información sobre las nuevas funciones, mejoras, correcciones de errores y problemas conocidos de la versión 2.4.2 de Magento Open Source.
...
Magento Open Source 2.4.2 incorpora mejoras en el rendimiento y la seguridad, además de mejoras significativas en la plataforma. Las mejoras de seguridad incluyen la ampliación de la compatibilidad con el atributo `SameSite` para todas las cookies. Ahora son compatibles Elasticsearch 7.9.x y Redis 6.x.
...
Para obtener información general acerca de los parches de seguridad, consulte [Versiones de parches de seguridad](../security/overview.md). Para obtener instrucciones sobre cómo descargar y aplicar parches de seguridad (incluido el parche 2.4.1-p1), consulte [Instalación rápida local](../../../installation/composer.md). Los parches de seguridad solo incluyen correcciones de errores de seguridad, no las mejoras de seguridad adicionales que se incluyen en el parche completo.
...
* La capacidad de configurar una instalación para utilizar una base de datos dividida ha quedado obsoleta en esta versión. Consulte [Revertir de una base de datos dividida a una sola base de datos](../../../configuration/storage/revert-split-database.md) para obtener instrucciones de migración.
...
* La aplicación ya no genera un error cuando intenta cambiar `backend-frontname` usando el contenedor `ssh` después de instalar Magento Open Source. [GitHub-26762](https://github.com/magento/magento2/issues/26762)
...
* Las consultas para los datos `categories.breadcrumbs` de un producto ya no devuelven datos de ruta de exploración para las categorías cuya categoría principal está deshabilitada. [GitHub-30468](https://github.com/magento/magento2/issues/30468)
...
* Magento Open Source ha mejorado el rendimiento de la caché al eliminar el vaciado de etiquetas varias veces por instancia del indexador. [GitHub-29890](https://github.com/magento/magento2/issues/29890)
...
Puede instalar Magento Open Source 2.4.2 con [Composer](../../../installation/composer.md).
