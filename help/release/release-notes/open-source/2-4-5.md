...
* Las bibliotecas de `jQuery Storage` se han reemplazado con `julien-maurel/js-storage`. <!-- AC-2627-->
...
Page Builder 1.7.2 es compatible con Magento Open Source 2.4.5.
...
* La ruta a Magento Open Source Analytics ya no está codificada. Anteriormente, esta ruta codificada provocaba conflictos cuando se instalaban varias instancias de Magento Open Source en un servidor. [GitHub-29373](https://github.com/magento/magento2/issues/29373)
...
* Los elementos de texto de opciones de tarjeta de crédito de información de pago o las imágenes de texto ahora cumplen con la relación de contraste de color mínima requerida de WCAG 2.0 de 4.5:1 para texto estándar de 18 pt (24 px) o 14 pt (19 px) si está en negrita. Anteriormente, no cumplían la relación de contraste esperada.
...
* Ahora se genera correctamente una nueva caché de productos después de agregar una nueva imagen con un nombre que contenga &quot;.&quot; a un producto, guardar el producto y limpiar la caché de imágenes. [GitHub-32699](https://github.com/magento/magento2/issues/32699)
...
* Los atributos de selección múltiple ahora se guardan correctamente durante la edición del producto. Anteriormente, la opción applicationOpen Source guardaba la opción predeterminada para atributos no seleccionados, así como para atributos seleccionados al guardar un producto.
...
* El método `isFreeShipping` ahora devuelve un entero en lugar de un booleano.[GitHub-35164](https://github.com/magento/magento2/issues/35164)
...
* Magento Open Source ahora muestra los gastos de envío gratuitos (0) en los totales de la página de facturas de administración y tienda. Anteriormente, cuando el envío era cero para un pedido, la aplicación Abrir Source no mostraba el importe de envío en total en el total de envío de la página de factura.
...
* Los comerciantes ahora pueden enviar un reembolso parcial por los pedidos pagados con Apple Pay a través de Braintree. Este era un problema conocido de Magento Open Source 2.4.4.
...
* Se corrigieron errores de PHP en las páginas `catalogsearch/advanced/result` y `catalogsearch/advanced/index`.  Anteriormente, Magento Open Source mostraba este error cuando se pasaba una matriz en cualquier cadena de búsqueda avanzada: `Warning: trim() expects parameter 1 to be string, array given | magento/module-catalog-search`. [GitHub-33586](https://github.com/magento/magento2/issues/33586)

### Envío

<!-- AC-2052-->

* Magento Open Source ya no genera un error al cargar las tarifas de envío de UPS si no se seleccionan los métodos de envío permitidos. Anteriormente, cuando un comprador introducía una dirección de envío en el flujo de trabajo de cierre de compra en estas condiciones, no se mostraban otros métodos de envío y Magento Open Source mostraba un error en la tienda. [GitHub-34411](https://github.com/magento/magento2/issues/34411)

<!-- AC-2621-->

* Los precios de los productos virtuales ahora se excluyen en el cálculo de la tarifa de envío de la tabla. Anteriormente, los costos de envío de estos productos no se calculaban correctamente.[GitHub-35185](https://github.com/magento/magento2/issues/35185)
