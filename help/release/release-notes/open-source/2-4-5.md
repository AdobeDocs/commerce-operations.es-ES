...
* Las sesiones del Magento Open Source ya no finalizan después de realizar una solicitud de GraphQL. Anteriormente, la variable `ClearCustomerSessionAfterRequest` plugin ha cerrado la sesión del comprador. [GitHub-34550](https://github.com/magento/magento2/issues/34550)
