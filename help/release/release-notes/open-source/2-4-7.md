...
* El método `OptionValueProvider` de clase `get()` ahora devuelve un valor de opción de atributo basado en el `option_id` dado según lo esperado. Anteriormente, devolvía un error. [GitHub-35910](https://github.com/magento/magento2/issues/35910)
...
* El texto informativo bajo el campo de entrada `Search Weight` del atributo `Storefront Properties` en Administración **[!UICONTROL Stores]** > **[!UICONTROL Attributes]** > **[!UICONTROL Product]** ahora describe posibles valores. [GitHub-36646](https://github.com/magento/magento2/issues/36675)
