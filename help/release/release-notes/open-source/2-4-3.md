...
* Las dependencias de la biblioteca Laminas se han actualizado a versiones compatibles con PHP 8.x. Se han quitado algunas dependencias redundantes del archivo `composer.json`. **El Magento Open Source 2.4.3 usa Laminas 3.4.0**. <!-- MC-39513-->
...
Puede instalar el Magento Open Source 2.4.3 con [Composer](../../../installation/composer.md).
