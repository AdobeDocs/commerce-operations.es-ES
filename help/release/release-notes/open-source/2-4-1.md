...
* Numerosas mejoras en la experiencia Mi cuenta de la tienda Venia <!-- PWA-247-->
...
* Polirellenos para `Map`, `WeakMap`, `FormData`, y `MutationObserver` ahora se cargan solo según sea necesario. _Corrección enviada por Dmitry Tsymbol en la solicitud de extracción [28330](https://github.com/magento/magento2/pull/28330)_. [GitHub-28377](https://github.com/magento/magento2/issues/28377)
...
Puede instalar Magento Open Source 2.4.1 con Composer.
