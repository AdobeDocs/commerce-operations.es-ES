...
Con la excepción de [Braintree](https://experienceleague.adobe.com/es/docs/commerce-admin/stores-sales/payments/braintree), todas las extensiones agrupadas por proveedores se han eliminado de la base de código de Magento Open Source 2.4.4. Los comerciantes deberían migrar a las extensiones oficiales, que están disponibles en [Commerce Marketplace](https://commercemarketplace.adobe.com//extensions.html).
