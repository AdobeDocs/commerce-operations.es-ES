...
* Las búsquedas en el catálogo de Elasticsearch ahora no distinguen entre diacríticos. Anteriormente, la búsqueda de términos sin acento daba como resultado resultados diferentes a los de búsquedas del mismo término con acento.
