...
* El Magento Open Source ahora devuelve un mensaje informativo cuando un `addProductsToCart` la mutación falla al añadir un producto al carro de compras con permisos insuficientes.
