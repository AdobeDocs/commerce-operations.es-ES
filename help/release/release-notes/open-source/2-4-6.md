...
description: Obtenga información sobre las nuevas funciones, mejoras, correcciones de errores y problemas conocidos de la versión de Magento Open Source 2.4.6.
...
Magento Open Source 2.4.6 presenta soporte para PHP 8.2. PHP 8.1 sigue siendo totalmente compatible, pero se ha eliminado el soporte para PHP 7.4. Incluye mejoras significativas en rendimiento y escalabilidad. Se han optimizado las operaciones de GraphQL para operaciones de carro de compras por lotes y respuesta de procesamiento del árbol de categorías.

Esta versión incluye más de correcciones y mejoras de calidad. Las dependencias del Compositor principal y las bibliotecas de terceros se han actualizado a las últimas versiones compatibles con PHP 8.2.
...
## Características destacadas de Magento Open Source 2.4.6
...
Consulte [Boletín de seguridad del Adobe](https://helpx.adobe.com/security/products/magento/apsb23-17.html) para conocer las últimas novedades sobre estos problemas corregidos.
...
Magento Open Source 2.4.6 presenta soporte para PHP 8.2. PHP 8.1 sigue siendo totalmente compatible. <!-- AC-6598 -->

La compatibilidad con PHP 7.4 se ha eliminado de esta versión. No se puede ejecutar el Magento Open Source 2.4.6 en PHP 7.4.

El Magento Open Source ahora admite:
...
* OpenSearch ahora se admite como motor de búsqueda predeterminado para implementaciones locales y en la nube de Magento Open Source. Se admite como motor de búsqueda independiente para Magento Open Source. Esta versión es compatible con OpenSearch v2.x y se ha probado con OpenSearch 2.5. Aunque sigue siendo compatible con OpenSearch 1.x, recomendamos utilizar esta versión con OpenSearch 2.x. Puede instalar y ejecutar Magento Open Source y Magento Open Source 2.4.6 con OpenSearch 2.x tanto en la nube como en los [requisitos previos del motor de búsqueda locales](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/prerequisites/search-engine/overview.html). <!-- AC-449 3555 -->

* Elasticsearch 8.x. Ver [Elasticsearch de actualización](../../../upgrade/prepare/prerequisites.md#upgrade-elasticsearch). <!-- AC-6597 -->
...
* Se ha eliminado la compatibilidad con PHP 7.4 de las bases de código Commerce y Magento Open Source. <!-- AC-2841-->
...
* `jquery-migrate` se ha eliminado de las bases de código de Commerce y Magento Open Source. [GitHub-21406](https://github.com/magento/magento2/issues/21406) <!-- AC-1199 -->

* Se ha actualizado la biblioteca `jQuery/fileUpload` a la versión 10.32. <!-- AC-2658-->

* Los componentes del marco Zend (ZF1) que han llegado al final de su vida útil se han eliminado de la base de código. Ver [resaltados de cambios incompatibles con versiones anteriores](https://developer-stage.adobe.com/commerce/php/development/backward-incompatible-changes/highlights/).<!-- AC-1512 -->
...
Los siguientes módulos IMS de Adobe se han desunido del código principal de Adobe Commerce y Magento Open Source y ahora se empaquetan como un metapaquete independiente:

* `adobe-ims`
* `adobe-ims-api`
* `admin-adobe-ims`

La nueva versión `adobe-ims-metapackage` v2.2.0 está integrada con Adobe Commerce 2.4.6 y el Magento Open Source 2.4.6. No se cambió ninguna funcionalidad en esta versión.<!-- CABPI-505-->

### Braintree

<!-- BUNDLE-3107-->

* Se han habilitado el botón **[!UICONTROL Pay Later]** y los titulares (mensajes) de Italia y España para Braintree.
...
Page Builder 1.7.3 es compatible con el Magento Open Source 2.4.6.

### PWA Studio

PWA Studio v.13.0.x es compatible con el Magento Open Source 2.4.6. Incluye varias mejoras para mejorar la accesibilidad. Para obtener información acerca de las correcciones de errores, consulte [Versiones de PWA Studio](https://github.com/magento/pwa-studio/releases). Consulte [Compatibilidad de versiones](https://developer.adobe.com/commerce/pwa-studio/integrations/adobe-commerce/version-compatibility/) para obtener una lista de versiones de PWA Studio y sus versiones principales de Adobe Commerce compatibles.
...
<!-- AC-2681-->
El Magento Open Source ahora genera un error de validación de parámetros cuando se utiliza la línea de comandos para establecer una conexión de Redis sin contraseña.
...
* El Magento Open Source ahora calcula correctamente el total general para los reembolsos de pedidos con un descuento en el envío.

<!-- ACP2E-876-->

* Google reCAPTCHA ahora funciona según lo esperado para pedidos de tiendas. Anteriormente, el Magento Open Source mostraba estos errores cuando Google ReCAPTCHA no se seleccionaba por primera vez antes de que un comprador intentara realizar un pedido por primera vez: `ReCaptcha validation failed, please try again` y `No such cart with id = ID`.
...
* El Magento Open Source ahora muestra una ventana emergente de confirmación como se espera antes de redirigir al comprador a la página siguiente cuando cambia la cantidad de productos en la página del carro de compras sin actualizar el carro de compras y luego intenta navegar a la página siguiente.

<!-- AC-5987-->

* Los compradores ahora pueden reducir la cantidad de un producto de su carro de compras después de que se haya reducido en el Administrador. Anteriormente, el Magento Open Source arrojaba el siguiente error cuando un comprador intentaba reducir la cantidad de productos: `The requested qty is not available`. [GitHub-35780](https://github.com/magento/magento2/issues/35780)

<!-- AC-6744-->

* El Magento Open Source ya no genera un error en la consola de JavaScript cuando la cantidad de productos supera el máximo configurado durante el cierre de compra de envío múltiple. Ahora, en su lugar, el Magento Open Source muestra un mensaje de error informativo. [GitHub-36184](https://github.com/magento/magento2/issues/36184)
...
* Los compradores ya no pueden añadir al carro de compras un producto de una categoría que ahora no está permitida después de cambiar el grupo de clientes al que pertenece el comprador. El Magento Open Source ahora comprueba el acceso a los permisos del grupo de clientes para categorías específicas cuando se han cambiado los ajustes de configuración de permisos.
...
* El Magento Open Source ahora devuelve un mensaje informativo cuando una mutación `addProductsToCart` falla al agregar un producto al carro de compras con permisos insuficientes.

<!-- ACP2E-1242-->

* El Magento Open Source ya no genera un error en la página del carro de compras cuando se utiliza el pedido rápido para añadir un producto en una cantidad que exceda el inventario disponible.
...
* El Magento Open Source ya no supone erróneamente que una categoría es la categoría principal de otra según la ruta de la categoría. Anteriormente, cuando dos categorías eran adyacentes y un ID de categoría empezaba por el ID de categoría de otra categoría, Adobe Commerce suponía que las categorías tenían la misma categoría principal. [GitHub-32464](https://github.com/magento/magento2/issues/32464)
...
* El Magento Open Source ya no genera un error cuando un usuario administrador agrega productos manualmente a un producto configurable que ya tiene muchos productos simples asignados. Anteriormente, el Magento Open Source mostraba este error: `Something went wrong with processing the default view and we have restored the filter to its original state`.

<!-- AC-2877-->

* Los compradores ya no pueden agregar productos configurables con una cantidad comercializable de 0 al carro de compras en implementaciones con pedidos pendientes deshabilitados. El Magento Open Source ahora indica que el producto está agotado. [GitHub-35319](https://github.com/magento/magento2/issues/35319)
...
* El trabajo cron de `catalog_index_refresh_price` ahora se ejecuta correctamente. Anteriormente, el Magento Open Source registraba este error durante la ejecución de cron: `report.ERROR: Cron Job catalog_index_refresh_price has an error: SQLSTATE[HY093]: Invalid parameter number: number of bound variables does not match number of tokens`.
...
* El Magento Open Source ya no envía correos electrónicos duplicados a los clientes después de crear un pedido desde el administrador.
...
* Ahora, las integraciones de OAuth se pueden volver a autorizar como se espera en implementaciones que ejecuten el Magento Open Source 2.4.3-p2. Anteriormente, se produjo este error en la reautorización: `The attempt to post data to consumer failed due to an unexpected error. Please try again later`. El Magento Open Source también intentó descifrar valores no cifrados. [GitHub-35313](https://github.com/magento/magento2/issues/35313)
...
* Los consumidores de AMQP ya no fallan debido a una función `trim()` obsoleta en implementaciones que ejecutan PHP 8.1. Anteriormente, cuando el consumidor de AMQP se iniciaba después de la instalación, el Magento Open Source arrojaba este error: `Deprecated Functionality: trim(): Passing null to parameter #1 ($string) of type string is deprecated in .../vendor/magento/framework-amqp/Config.php on line 143`. [GitHub-35380](https://github.com/magento/magento2/issues/35380)

<!-- AC-2882-->

* El método `getFilteredTimerIds` ahora funciona según lo esperado.  La clase `Magento\Framework\Profiler\Driver\Standard\Stat` ahora es compatible con PHP 8.1. Anteriormente, el Magento Open Source producía una excepción cuando se llamaba a este método. [GitHub-35307](https://github.com/magento/magento2/issues/35307)
...
* El Magento Open Source ahora muestra un intervalo de tiempo preciso cuando un usuario administrador selecciona la opción **[!UICONTROL Last 24 Hours]** del panel de estadísticas de administración. Anteriormente, el Magento Open Source mostraba un intervalo de tiempo incorrecto. Esto ocurrió porque la zona horaria de la base de datos permaneció sin cambios.
...
* Los pedidos duplicados ya no son el resultado de solicitudes de GraphQL simultáneas e idénticas. Las ofertas ahora están bloqueadas durante un máximo de 10 segundos para evitar la creación de pedidos duplicados y la segunda solicitud falla con estos errores: `The cart isn't active` o `The order has already been placed and is currently processing`. Este valor de bloqueo se puede configurar mediante el id. para el parámetro `lockWaitTimeout` de clase `Magento\Quote\Model\PlaceOrderMutex`. [GitHub-36274](https://github.com/magento/magento2/issues/36274)
...
* Realizar un pedido facturado automáticamente de un producto gratuito cuando la indexación asíncrona está habilitada ahora funciona según lo esperado. No se agregaron entradas a la tabla `sales_order_grid or sales_invoice_grid` para estos pedidos. Anteriormente, el Magento Open Source arrojó una excepción porque la aplicación intentó indexar las cuadrículas durante la colocación del pedido en lugar de depender de `cron`. [GitHub-36334](https://github.com/magento/magento2/issues/36334)
...
* Los usuarios administradores ahora pueden crear un pedido o reordenar cuando el método de pago del Braintree está activado. Anteriormente, el Magento Open Source arrojó este error: `report.CRITICAL: Error: Call to a member function getMethodInstance() on null in /app/vendor/paypal/module-braintree-core/Block/Form.php:174`.

<!-- BUNDLE-3139-->

* El proceso de pago mediante el método de pago al Braintree ahora se completa correctamente cuando el Braintree PayPal está habilitado y **[!UICONTROL Enable Card Payments]** está deshabilitado. Anteriormente, la barra de progreso nunca se resolvía y el Magento Open Source mostraba este error de consola: `adapter.js:66 Uncaught TypeError: Cannot read properties of undefined (reading 'clientToken')at Object.getClientToken (adapter.js:66:66)`. [GitHub-35961](https://github.com/magento/magento2/issues/35961)
...
* La opción de método de pago de Braintree Vault permanece seleccionada en el flujo de trabajo de cierre de compra cuando un comprador actualiza su dirección de facturación. Anteriormente, el método de pago se anulaba cuando el comprador anulaba la selección del botón **[!UICONTROL My billing and shipping address are the same]**.
...
* Los usuarios administradores ahora pueden crear un pedido o repedido para los clientes cuando el método de pago del Braintree está activado. Anteriormente, el Magento Open Source arrojó este error: `report.CRITICAL: Error: Call to a member function getMethodInstance() on null in /app/vendor/paypal/module-braintree-core/Block/Form.php:174`

<!-- BUNDLE-3139-->

* Los compradores ahora pueden usar el método de pago del Braintree en tiendas donde **[!UICONTROL Enable Card Payments]** se ha deshabilitado. Anteriormente, el Magento Open Source arrojó este error de JavaScript: `_adapter.js:66 Uncaught TypeError: Cannot read properties of undefined (reading 'clientToken')at Object.getClientToken (adapter.js:66:66).`
...
* Las búsquedas de cadenas entre comillas ahora funcionan según lo esperado cuando el valor de configuración **[!UICONTROL Minimum Terms to Match]** está habilitado. Anteriormente, el Magento Open Source arrojó este error: `{"error":{"root_cause":[{"type":"parsing_exception","reason":"[match_phrase] query does not support [minimum_should_match]' ...`.
...
* Ahora, el Magento Open Source puede mostrar productos agrupados con impuestos en la página de categoría de tienda en implementaciones que ejecuten PHP 8.1. Anteriormente, el Magento Open Source no mostraba una lista de productos y lanzó esta excepción: `main.CRITICAL: Exception: Deprecated Functionality: ucfirst(): Passing null to parameter #1 ($string) of type string is deprecated in /var/www/m24/vendor/magento/module-tax/Pricing/Render/Adjustment.php on line 188 in /var/www/m24/vendor/magento/framework/App/ErrorHandler.php:61`. [GitHub-35500](https://github.com/magento/magento2/issues/35500)
...
* La asignación automática de grupos de clientes ahora funciona cuando no hay ningún ID de IVA asociado a la dirección del cliente. Si la dirección no contiene un ID de IVA, se trata como perteneciente a un cliente registrado sin IVA y el Magento Open Source cambia el grupo de clientes a un grupo sin IVA. Anteriormente, cuando se habilitaba **[!UICONTROL Enable Automatic Assignment to Customer Group]**, la cuenta de cliente no se asignaba automáticamente a `customerGroup` cuando se eliminaba el identificador de IVA de la cuenta de cliente.
...
* Se agregó texto informativo debajo del campo de entrada `Storefront Properties` del atributo `Search Weight` en el administrador **[!UICONTROL Stores]**  > [!UICONTROL Attributes] > **[!UICONTROL Product]**.
...
* La configuración del encabezado del tema `Welcome Text` ahora puede contener un carácter de comillas simples. Anteriormente, el Magento Open Source arrojó este error de JavaScript: `Uncaught SyntaxError: Unable to process binding "ifnot: function(){return customer().fullname }"`.
...
* El servicio de moneda Fixer ahora funciona como se espera con las claves generadas a través de ApiLayer, y las tasas de moneda se exportan correctamente. Anteriormente, el Magento Open Source generaba un error cuando un comerciante intentaba importar tipos de cambio a través del administrador.
...
Puede instalar el Magento Open Source 2.4.6 con [Composer](../../../installation/composer.md).
