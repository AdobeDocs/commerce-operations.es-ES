---
title: Notas de la versión de Adobe Commerce 2.4.6-p4
description: Obtenga información acerca de las correcciones para problemas de seguridad en la versión 2.4.6-p4 de Adobe Commerce.
...
# Notas de la versión de Adobe Commerce 2.4.6-p4

Adobe Commerce 2.4.6-p4 es una versión de seguridad que proporciona cinco correcciones de seguridad que mejoran su implementación de Adobe Commerce 2.4.6 o Magento Open Source 2.4.6. Proporciona correcciones para las vulnerabilidades que se han identificado en versiones anteriores.
