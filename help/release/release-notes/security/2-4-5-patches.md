...
>
>Después de esta fecha, Adobe Commerce 2.4.5 no proporcionará compatibilidad ni
...
>
>Todos los clientes locales de Adobe Commerce que ejecutan la versión 2.4.5 tienen una
...
Adobe Commerce 2.4.5 ahora es compatible con Valkey 8.1 LTS, proporcionando una opción de back-end de caché de soporte a largo plazo compatible con Adobe Commerce en la infraestructura en la nube.
...
#### Compatibilidad con Apache ActiveMQ Artemis

Debido al riesgo de fin de soporte asociado con RabbitMQ 4, Adobe Commerce ha iniciado una migración estratégica a Apache ActiveMQ Artemis para garantizar la estabilidad a largo plazo y el soporte para su infraestructura de cola de mensajes.

* Adobe Commerce 2.4.5 ahora es compatible con la última versión de Apache ActiveMQ Artemis.
* La compatibilidad con RabbitMQ 4.1 se mantiene para apoyar a los clientes que prefieren permanecer en el servicio MQ existente.
* ActiveMQ ahora es totalmente compatible con Adobe Commerce Cloud, incluidas las implementaciones de AWS ActiveMQ para nativos de la nube.

#### Compatibilidad de 2.4.5-p16 con MariaDB 10.11

Se ha comprobado la compatibilidad de Adobe Commerce 2.4.5-p16 con MariaDB 10.11, aunque sigue siendo totalmente compatible con MariaDB 10.6. Los comerciantes que actualmente ejecutan 2.4.5-px pueden actualizar de forma segura a 2.4.5-p16 y pasar de MariaDB 10.6 a MariaDB 10.11.
