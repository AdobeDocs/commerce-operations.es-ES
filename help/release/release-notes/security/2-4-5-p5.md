---
title: Notas de la versión de Adobe Commerce 2.4.5-p5
description: Obtenga información acerca de las correcciones para problemas de seguridad en la versión 2.4.5-p5 de Adobe Commerce.
...
# Notas de la versión de Adobe Commerce 2.4.5-p5

Adobe Commerce 2.4.5-p5 es una versión de seguridad que proporciona diez correcciones de seguridad que mejoran su implementación de Adobe Commerce 2.4.5 o Magento Open Source 2.4.5. Proporciona correcciones para las vulnerabilidades que se han identificado en versiones anteriores.
