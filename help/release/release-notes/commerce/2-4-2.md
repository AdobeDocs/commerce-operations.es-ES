...
* [Amazon Pay](https://docs.magento.com/user-guide/payment/amazon-pay.html). Amazon Pay se ha desaprobado en esta versión y se eliminará en Magento 2.5.0. La versión 2.4.3 y posteriores solo contendrán actualizaciones para la compatibilidad y correcciones de errores importantes.
