...
* [Nube de vértices](https://commercemarketplace.adobe.com//vertexinc-vertex-tax-module.html)

* [Reseñas de productos Yotpo](https://commercemarketplace.adobe.com//yotpo-module-yotpo.html)
...
* Los valores booleanos ya no se establecen para `image_with_border.phtml`. Se ha quitado la configuración redundante `max-width` y `height` de `.product-image-photo`. (Estos valores ya se han establecido globalmente en la imagen mediante los estilos restablecidos). [GitHub-30186](https://github.com/magento/magento2/issues/30186)
