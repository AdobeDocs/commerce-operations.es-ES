...
Adobe Commerce 2.4.2 incorpora mejoras en el rendimiento y la seguridad, además de mejoras significativas en la plataforma. Las mejoras de seguridad incluyen la ampliación de la compatibilidad con el atributo `SameSite` para todas las cookies. Las mejoras de B2B se centran en la compatibilidad con los pagos en línea para pedidos de compra. Ahora son compatibles Elasticsearch 7.9.x y Redis 6.x.
...
Los comerciantes ahora pueden instalar correcciones de seguridad urgentes sin aplicar los cientos de correcciones y mejoras funcionales que ofrece una versión trimestral completa (por ejemplo, 2.4.1-p1). El parche 2.4.0.12 (Paquete de composición 2.4.1-p1) es un parche de seguridad que proporciona correcciones para vulnerabilidades que se han identificado en nuestra versión trimestral anterior, 2.4.1. Todas las correcciones rápidas aplicadas a la versión 2.4.1 se incluyen en este parche de seguridad. (Una *corrección rápida* proporciona una corrección de una versión publicada que soluciona un problema o error específico).

Para obtener información general acerca de los parches de seguridad, consulte [Notas de la versión de los parches de seguridad](../security/overview.md). Para obtener instrucciones sobre cómo descargar y aplicar parches de seguridad (incluido el parche 2.4.1-p1), consulte [Instalación rápida local](../../../installation/composer.md). Los parches de seguridad solo incluyen correcciones de errores de seguridad, no las mejoras de seguridad adicionales que se incluyen en el parche completo.
...
* [**Ahora se admite Elasticsearch 7.9.x**](../../../installation/system-requirements.md). Aunque se recomienda ejecutar Elasticsearch 7.9.x, la versión 2.4.x sigue siendo compatible con Elasticsearch 7.4.x. <!-- MC-36867-->
...
La capacidad de configurar una instalación para utilizar una base de datos dividida ha quedado obsoleta en esta versión. Los comerciantes que actualmente utilizan bases de datos divididas deben empezar a planificar la reversión a una sola base de datos o la migración a ella, o utilizar un método alternativo. Consulte [Revertir de una base de datos dividida a una sola base de datos](../../../configuration/storage/revert-split-database.md) para obtener instrucciones de migración.
...
* Se ha agregado compatibilidad con varias listas de deseos. Puede usar GraphQL para [crear](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/create/), [eliminar](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/delete/) y [cambiar el nombre de](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/update/) listas de deseos, así como para [mover](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/move-products/) o [copiar](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/copy-products/) elementos entre ellas. <!-- MC-32356-->

* Compatibilidad añadida para las autorizaciones de comercialización devueltas (RMA). Los compradores pueden [solicitar una devolución](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/mutations/request-return/). Si el comerciante acepta la solicitud, el comprador puede realizar tareas como [agregar un comentario](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/mutations/add-return-comment/) y [agregar información de seguimiento](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/mutations/add-return-tracking/). <!-- MC-34596-->

* Se ha añadido compatibilidad con las siguientes funciones B2B:
   * Compañías. Puede agregar [administradores](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/mutations/create/), [usuarios](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/mutations/create-user/), [roles](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/mutations/create-role/) y [equipos](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/mutations/create-team/) de la empresa. <!-- MC-33861-->
   * Crédito de la empresa. La [consulta de la compañía](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/queries/company/) incluye detalles sobre el historial de crédito de la compañía. <!-- MC-33862-->
   * Listas de solicitudes. Puede [crear](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/create/), [eliminar](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/delete/) y [actualizar](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/update/) listas de solicitudes. La compatibilidad también incluye la posibilidad de [agregar](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/add-products/), [actualizar](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/update-products/), [eliminar](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/delete-items/), [copiar](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/copy-items/) y [mover](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/move-items/) elementos dentro de una lista de solicitudes, así como agregar elementos de la lista de solicitudes [al carro](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/add-items-to-cart/). <!-- MC-34312-->

* Se ha añadido apoyo a los sindicatos en GraphQL. [GitHub-29425](https://github.com/magento/magento2/issues/29425) <!-- ENGCOM-8291 -->

* Se agregó compatibilidad con [listas de comparación](https://developer.adobe.com/commerce/webapi/graphql/schema/products/queries/compare-list/). Los compradores pueden [crear](https://developer.adobe.com/commerce/webapi/graphql/schema/products/mutations/create-compare-list/) y [eliminar](https://developer.adobe.com/commerce/webapi/graphql/schema/products/mutations/delete-compare-list/) listas de comparación, y [agregar](https://developer.adobe.com/commerce/webapi/graphql/schema/products/mutations/add-products-to-compare-list/) y [eliminar](https://developer.adobe.com/commerce/webapi/graphql/schema/products/mutations/remove-from-compare-list/) elementos a las listas de comparación. Además, los compradores que creen una lista de comparación como invitados pueden iniciar sesión como clientes y [conservar](https://developer.adobe.com/commerce/webapi/graphql/schema/customer/mutations/assign-compare-list/) sus listas de comparación.

* Se agregó la mutación [`generateCustomerTokenAsAdmin`](https://developer.adobe.com/commerce/webapi/graphql/schema/customer/mutations/generate-token-as-admin/) y se actualizó el objeto `Customer` para admitir la asistencia de compra remota.
...
* Se agregó el atributo `staging` a [`ProductInterface`](https://developer.adobe.com/commerce/webapi/graphql/schema/products/interfaces/attributes/) y [`CategoryInterface`](https://developer.adobe.com/commerce/webapi/graphql/schema/products/interfaces/category/) para determinar si un producto está ensayado y para ver su información de campaña asociada. <!-- MC-33897-->
...
Esta versión también incluye varias correcciones de errores. Ver [Notas de la versión B2B](https://experienceleague.adobe.com/docs/commerce-admin/b2b/release-notes.html?lang=es).
...
* Page Builder ya no requiere que todos los tipos de contenido se coloquen dentro de una fila. La fase [Page Builder](https://experienceleague.adobe.com/es/docs/commerce-admin/page-builder/walkthrough/3-catalog-content#stage) está ahora inicialmente en blanco y admite la adición de los siguientes tipos de contenido directamente a la fase: Filas, Columnas, Pestañas, Código HTML, Bloques, Bloques dinámicos.
...
* [Amazon Pay](https://commercemarketplace.adobe.com//amzn-amazon-pay-magento-2-module.html). Amazon Pay se ha desaprobado en esta versión y se eliminará en Magento 2.5.0. La versión 2.4.3 y posteriores solo contendrán actualizaciones para la compatibilidad y correcciones de errores importantes.
...
* [Yotpo Reseñas de productos](https://commercemarketplace.adobe.com//yotpo-module-yotpo.html)
...
* El método de pago predeterminado PayPal Express Checkout funciona ahora según lo esperado con el método de pago con tarjeta de crédito Braintree. Anteriormente, la aplicación no mostraba el botón **PayPal** cuando el método de pago con tarjeta de crédito de Braintree estaba habilitado.
...
* La aplicación ahora vuelve a crear imágenes correctamente y estas imágenes son visibles en el administrador como se espera cada vez que un comerciante envía datos de la galería de medios mediante POST `rest/all/V1/products`. Anteriormente, la aplicación recreaba las imágenes pero las eliminaba cuando un comerciante enviaba datos de la galería de medios mediante el POST `rest/all/V1/products` si las imágenes se eliminaban en `pub/media` pero aún había registros en medios que contenían registros para estas imágenes. Como resultado, el comerciante solo vio marcadores de posición en el Administrador porque las imágenes se crearon y eliminaron durante el proceso de actualización.

<!-- MC-36903-->

* Los registros ahora se eliminan según lo esperado cuando se anula la asignación de un elemento de un sitio web. Anteriormente, las imágenes se duplicaban cuando se ejecutaba POST `rest/all/V1/products`.
...
* La aplicación ahora convierte correctamente el texto sin formato a HTML al hacer clic en **Devolver la versión HTML** al cargar una plantilla de correo electrónico.
...
* Las imágenes de la página principal de una tienda ahora se representan correctamente. Anteriormente, el HTML de origen de página estaba dañado porque las tres barras consecutivas en el código base64 de la imagen se interpretaban erróneamente como un comentario.
...
* La aplicación ahora aplica el ajuste de configuración **Logotipo para la vista de impresión de HTML** a los PDF de facturas de tienda según lo esperado. [GitHub-24730](https://github.com/magento/magento2/issues/24730)
...
* La minificación de HTML ya no elimina las barras triples (//) de las cadenas de HTML en los archivos PHTML. Anteriormente, las barras triples se interpretaban como comentarios durante la minificación y el resto de la línea se eliminaba completamente en el archivo PHTML generado al implementarse.
...
* La aplicación ahora muestra el mensaje de bienvenida como se espera después de que un comprador inicie sesión en una tienda en la que esté habilitado el carro de compras persistente. Anteriormente, la aplicación mostraba **¿No eres tú?** después de iniciar sesión.

<!-- MC-38269-->

* La aplicación ya no muestra **¿No eres tú?** Enviar un mensaje de texto cuando un cliente seleccione la opción **Recordarme** al iniciar sesión en una implementación en la que esté habilitado el carro de compras persistente.
...
* El tipo de nombres de producto de Elasticsearch en los resultados de búsqueda ya no distingue entre mayúsculas y minúsculas.
...
* El indexador de búsqueda en el catálogo ahora se ejecuta sin arrojar un error debido al límite de campos de Elasticsearch. Anteriormente, la aplicación arrojó este error: `Limit of total fields [xxx] in index [m24dev_product_1_v10] has been exceeded`.

<!-- MC-35491-->

* El rendimiento de la búsqueda en el catálogo ha mejorado. Deshabilitar **Activar sugerencias de búsqueda** (**Tiendas** > **Configuración** > **Catálogo** > **Búsqueda en el catálogo** ) funciona según lo esperado. Anteriormente, la aplicación consultaba la tabla MySQL `search_query` en lugar de Elasticsearch para sugerencias de búsqueda de autocompletar. [GitHub-25534](https://github.com/magento/magento2/issues/25534)

<!-- MC-35256-->

* Elasticsearch ahora filtra los precios de los productos igual que MySQL. El tipo de campo `price_*` se cambió de `float` a `double` en el índice de Elasticsearch para mejorar la precisión y corregir un error de punto flotante.
...
* Elasticsearch ya no genera un error, sino que no muestra ningún producto como se espera cuando se usa un valor `string` para filtrar productos por atributo con un tipo de servidor `integer` o `decimal`. Anteriormente, la aplicación mostraba este error en `exception.log`: `number format exception`.

<!-- ENGCOM-8303 -->

* Elasticsearch ya no genera una excepción cuando un término de búsqueda contiene `/`.  [GitHub-25886](https://github.com/magento/magento2/issues/25886), [GitHub-25110](https://github.com/magento/magento2/issues/25110)
...
* La aplicación ya no muestra HTML sin procesar en las páginas de resumen de facturas y envíos. [GitHub-29958](https://github.com/magento/magento2/issues/29958)
