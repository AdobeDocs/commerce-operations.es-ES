...
Con la excepción de [Braintree](https://experienceleague.adobe.com/es/docs/commerce-admin/stores-sales/payments/braintree), todas las extensiones agrupadas por proveedores se han eliminado de la base de código de Adobe Commerce 2.4.4. Los comerciantes deben migrar a las extensiones oficiales, que están disponibles en [Commerce Marketplace](https://marketplace.magento.com/extensions.html). <!-- AC-1165-->
