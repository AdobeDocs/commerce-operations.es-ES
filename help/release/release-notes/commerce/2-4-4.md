...
* **Cobertura completa de GraphQL para cotizaciones negociables**.  Los usuarios de la empresa B2B ahora pueden completar todas las tareas relacionadas con cotizaciones negociables mediante GraphQL. Las versiones anteriores de esta API admitían flujos de negociación, pero no de cierre de compra. <!-- PWA-2101-->
...
* GraphQL ahora proporciona a New Relic nombres descriptivos de transacciones, que pueden resultar útiles para la depuración. [GitHub-30915](https://github.com/magento/magento2/issues/30915)
