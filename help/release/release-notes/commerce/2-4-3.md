...
[Live Search](https://experienceleague.adobe.com/en/docs/commerce/live-search/overview) impulsado por [Adobe Sensei](https://www.adobe.com/sensei.html) ofrece un experiencia de búsqueda intuitivo mediante el uso de algoritmos de aprendizaje artificial y inteligencia artificial para realizar una análisis profunda de datos sobre visitantes agregados.Consulte [las notas](https://experienceleague.adobe.com/docs/commerce/live-search/release-notes.html) de la versión de Search en vivo.
...
* `ramsey/uuid`se ha actualizado para compatibilidad con PHP 8.0. [GitHub-31777, [](https://github.com/magento/magento2/issues/31777)GitHub-826](https://github.com/magento/magento2-functional-testing-framework/issues/826)
