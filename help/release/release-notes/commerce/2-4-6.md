...
Adobe Commerce 2.4.6-beta5 ahora es compatible:
...
**Se han optimizado los permisos de producto** con fragmentos en línea de productos. <!-- B2B-2459-->
...
* Las opciones de producto configurables ahora se muestran según lo esperado como sin existencias en la tienda si la opción se creó con una cantidad establecida en 0 y **Mostrar productos fuera de existencias** está activada.
