...
## 2.4.6-beta2: entorno de prueba

Adobe Commerce 2.4.6-beta2 se ha probado con las siguientes versiones de componentes:
...
Adobe Commerce 2.4.6-beta2 presenta compatibilidad con PHP 8.2. PHP 8.1 sigue siendo totalmente compatible.  <!-- AC-6598 -->

La compatibilidad con PHP 7.4 se ha eliminado de esta versión. No puede ejecutar Adobe Commerce en PHP 7.4.

Adobe Commerce 2.4.6-beta2 ahora admite:
...
Estamos solucionando cientos de problemas en el código principal de Adobe Commerce 2.4.6. A continuación se describe un subconjunto de los problemas corregidos incluidos en Adobe Commerce 2.4.6-beta2.
...
* Las respuestas de consulta de GraphQL ahora incluyen información sobre los productos secundarios de los productos del paquete en la variable `product` de la sección `options` bloque.
...
* El cliente `order` query ahora devuelve pedidos de todos los sitios web, tiendas y vistas de tiendas especificados según lo esperado. Esta corrección incluye la creación de un nuevo argumento de solicitud.
