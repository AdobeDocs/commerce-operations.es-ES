...
* [IU de administración de Adobe Commerce SDK](https://developer.adobe.com/commerce/extensibility/admin-ui-sdk/)
...
[Opciones de pago](https://experienceleague.adobe.com/docs/commerce/payment-services/payments-checkout/payments-options.html) presenta métodos de pago compatibles.
...
* El encabezado X-Magento-Cache-Id se ha eliminado de las respuestas de mutación de GraphQL. Dado que las mutaciones son operaciones de cambio de estado (como añadir elementos al carro de compras o realizar un pedido), no están pensadas para almacenarse en caché. Incluir este encabezado era engañoso y podría provocar un comportamiento incorrecto si se aplicaba el almacenamiento en caché. Este cambio se adhiere a las prácticas recomendadas de GraphQL y a los principios básicos de la arquitectura de Adobe Commerce.
