...
Adobe Commerce y Magento Open Source 2.4 requieren una instalación limpia de MySQL 8.0. Siga los enlaces a continuación para obtener instrucciones sobre la instalación de MySQL en su máquina.
