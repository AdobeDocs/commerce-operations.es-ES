...
[Configuración de implementación](../../configuration/reference/deployment-files.md) proporciona la información que la aplicación necesita para inicializarse y arrancarse.
...
Al configurar un sistema de producción, se recomienda importar las opciones de configuración de `config.php` y `env.php` en la base de datos.
...
El indicador `[-n, --no-interaction]` opcional permite que el comando se ejecute sin confirmaciones adicionales.

Para obtener más información, consulte [Importar datos de archivos de configuración](../../configuration/cli/import-configuration.md)
