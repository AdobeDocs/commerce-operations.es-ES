...
Usamos [Compositor](https://getcomposer.org/) para administrar los componentes de Adobe Commerce y Magento Open Source y sus dependencias. Uso del Compositor para obtener el Adobe Commerce y el Magento Open Source [metapackage](https://glossary.magento.com/metapackage) proporciona las siguientes ventajas:
