...
| Comprueba los eventos que se han registrado como prioritarios en [Eventos de Adobe I/O para Adobe Commerce](https://developer.adobe.com/commerce/events/get-started/). |
| `exportProcessor` | + | + | + |
