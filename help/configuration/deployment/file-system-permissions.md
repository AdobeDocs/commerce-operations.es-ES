...
Este tema se centra en los sistemas de desarrollo y producción de Commerce. Si va a instalar Commerce, consulte [Establecer la propiedad y los permisos previos a la instalación](../../installation/prerequisites/file-system/configure-permissions.md).
...
Consulte [Establecer opcionalmente una máscara de usuario](../../installation/next-steps/set-umask.md) en la _Guía de instalación_.
...
- El **usuario de línea de comandos**, con el que inicia sesión en el servidor de Commerce o cambia a.
  ...
  >[!INFO]
  >
  >El usuario de la línea de comandos también se conoce como _propietario del sistema de archivos_.

Puesto que estos usuarios necesitan acceso a los mismos archivos, le recomendamos que cree un [grupo compartido](../../installation/prerequisites/file-system/configure-permissions.md#about-the-shared-group) al que ambos pertenezcan. Los siguientes procedimientos suponen que ya lo ha hecho.
...
>[!INFO]
>
>`setgid` se aplica solamente a directorios, _no_ a archivos.
