---
title: Configuración de Valkey para el almacenamiento de sesión
description: Aprenda a configurar Valkey para el almacenamiento de sesiones en Adobe Commerce. Descubra la configuración de CLI, los parámetros de sesión y las técnicas de verificación de conexiones.
...
# Configuración de Valkey para el almacenamiento de sesión

{{cloud-cache-config}}

Commerce proporciona opciones de línea de comandos para configurar el almacenamiento de sesión de Valkey. Aunque puede configurar el almacenamiento de sesión mediante la edición del archivo `<Commerce-install-dir>/app/etc/env.php`, el método recomendado es usar la línea de comandos, especialmente para las configuraciones iniciales. La línea de comandos proporciona validación, lo que garantiza que la configuración sea sintácticamente correcta.

>[!IMPORTANT]
>
>Para poder configurar el almacenamiento de la sesión, debe tener [Valkey instalado](config-valkey.md#install-valkey).

## Configuración del almacenamiento de sesión de Valkey
