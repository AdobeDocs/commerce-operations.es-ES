...
| Límite de cantidad de invitaciones a conversiones de pedidos | `magento_reward/points/invitation_order_limit` | ![Solo de comercio](/help/assets/configuration/cloud-ee.png) |
