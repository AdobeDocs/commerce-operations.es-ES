...
---
# Puntos destacados de la versión beta1 de Adobe Commerce 2.4.8 de octubre de 2024
...
<table style="table-layout:auto">
    <tbody>
        ...
        <tr>
            ...
            <td>Adobe Commerce ahora está optimizado para OpenSearch 2.x y ya no es compatible con Elasticsearch. Todos los módulos y clases de Elasticsearch 7 y 8 ya no se utilizan en el código base. Adobe recomienda encarecidamente realizar la transición a OpenSearch para implementaciones de infraestructura tanto locales como en la nube a fin de garantizar una compatibilidad y un soporte continuos. Ver <a href="/help/upgrade/prepare/opensearch-migration.md">Migrando a OpenSearch</a>.
              <ul>
