...
---
# Notas de la versión de Magento Open Source (versión 2.4.8-beta2)

## Aspectos destacados en la versión 2.4.8-beta2

La versión 2.4.8 de Magento Open Source cuenta con los siguientes 30 aspectos destacados.

### Braintree

* _PAQUETE-3400_: Quitar LPM no compatibles
   * _Contribución de código de GitHub_: <https://github.com/magento/ext-braintree/pull/208>
* _PAQUETE-3401_: Marca de pago de Google
   * _Contribución de código de GitHub_: <https://github.com/magento/ext-braintree/pull/208>
* _PAQUETE-3402_: Marca de pago de Apple
   * _Contribución de código de GitHub_: <https://github.com/magento/ext-braintree/pull/208>
* _PAQUETE-3403_: devolución de llamada de envío de pago de Google
   * _Contribución de código de GitHub_: <https://github.com/magento/ext-braintree/pull/208>
* _PAQUETE-3404_: Pagar más tarde por mensajería
   * _Contribución de código de GitHub_: <https://github.com/magento/ext-braintree/pull/208>
* _PAQUETE-3405_: botón JS-SDK
   * _Contribución de código de GitHub_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3406_: Optimizar código dentro de la extensión de Braintree
   * _Contribución de código de GitHub_: <https://github.com/magento/ext-braintree/pull/208>
* _PAQUETE-3407_: Actualice Braintree PHP y JS SDK
   * _Contribución de código de GitHub_: <https://github.com/magento/ext-braintree/pull/208>
* _PAQUETE-3408_: elementos de línea (GooglePay)
   * _Contribución de código de GitHub_: <https://github.com/magento/ext-braintree/pull/208>
* _PAQUETE-3409_: elementos de línea (Apple Pay)
   * _Contribución de código de GitHub_: <https://github.com/magento/ext-braintree/pull/208>
* _PAQUETE-3420_: Seguimiento de paquetes
   * _Contribución de código de GitHub_: <https://github.com/magento/ext-braintree/pull/208>

### Marco

* _AC-12012_: actualizar la versión de Nginx de 1.24 a 1.26
* _AC-12028_: Agregue compatibilidad con la última versión de Composer 2.8 para 2.4.8 y 2.4.7
* _AC-12029_: compruebe la compatibilidad con Varnish 7.6
* _AC-12970_: actualización a PHPUnit 10, parte 2: quitar obsolescencias
...
* _AC-13076_: actualice toda la biblioteca js y la dependencia npm con la última versión disponible
...
* _AC-13077_: todas las extensiones agrupadas y los componentes integrados son compatibles con PHP 8.4
* _AC-13078_: todas las herramientas de Adobe Commerce son compatibles con PHP 8.4
* _AC-13079_: todas las láminas/dependencias del proyecto Adobe Commerce son compatibles con PHP 8.4
* _AC-13256_: modifica la dependencia de TinyMCE de la versión 7 a la versión 6.8.5
* _AC-13276_: las obsolescencias de PHP 8.4 requieren cambios importantes en Adobe Commerce
* _AC-8828_: establecer intercalación predeterminada en utf8mb4 para MySQL

### Otros

* _AC-12133_: El código principal de Adobe Commerce 2.4.8 es compatible con PHP 8.4
* _AC-12972_: Mejoras de calidad de núcleo 2.4.8-beta2
* _AC-13038_: elimine PHP 8.1 de composer.json y todo el soporte relacionado
...
* _AC-10982_: [2FA] Integrar con Duo Web SDK para admitir el indicador universal
   * _Nota de corrección_: por determinar

### Marco de prueba

* _AC-9037_: capacidad de usar copyright de Adobe para código fuente de Adobe Commerce

### Marco de IU

* _AC-12944_: elimine TinyMCE 5 de Adobe Commerce

## Se han corregido problemas en la versión 2.4.8-beta2

Hemos corregido 159 problemas en el código principal de Magento Open Source 2.4.8. A continuación, se describe un subconjunto de los problemas corregidos que se incluyen en esta versión.
