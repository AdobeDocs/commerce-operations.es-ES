...
#### Problema de rendimiento con el nuevo parche de configuración en B2B
...
#### [Empaquetado] Corrija la dependencia estándar de magento/magento+ page-builder
...
#### El documento debe actualizarse para la implementación de % que no sea correcta en el documento oficial
