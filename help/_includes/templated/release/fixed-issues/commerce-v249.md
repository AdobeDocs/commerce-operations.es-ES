...
#### La información del conjunto de atributos se almacena en caché (caché de EAV), pero no se limpia después de actualizar el conjunto de atributos en el área de administración

Se han resuelto los valores de atributos de producto que faltaban después de que se agregaran nuevos atributos a un conjunto de atributos cuando la caché de EAV estaba habilitada (invalidación de la caché/comportamiento de importación de la API).

_AC-12321 - [Problema de GitHub](https://github.com/magento/magento2/issues/38827) - [Contribución de código de GitHub](https://github.com/magento/magento2/pull/38864)_
...
#### La galería de medios de GraphQl devuelve las entradas desactivadas.

Se ha corregido el problema para obtener solo las imágenes de la galería de medios que no están deshabilitadas para un producto en la respuesta de solicitud de graphql.

_AC-1608 - [Problema de GitHub](https://github.com/magento/magento2/issues/34342) - [Contribución de código de GitHub](https://github.com/magento/magento2/pull/34897)_
...
Anteriormente, se enviaban cuerpos de solicitud o parámetros con formato incorrecto a varios extremos de API de REST (como /V1/carts/search, /V1/orders, /V1/products, etc.) resultó en un &quot;Error interno del servidor&quot; (500) genérico, lo que dificulta el diagnóstico de problemas de entrada.
...
Las API de REST V1/guest-carts/&lt;cartId>/items/ y V1/carts/mine/items/ ahora validan &quot;product_options.extension_attributes.custom_options.*.option_id&quot; para asegurarse de que hacen referencia a un option_id válido para el SKU del elemento del carro de compras. Anteriormente, este parámetro se procesaba y se guardaba en la base de datos sin validación.
...
#### La cola [CLOUD] no se está borrando

Se ha mejorado la resistencia del consumidor de AMQP al bloquear los intentos de bloqueo/rechazo no válidos en los canales reconectados.

_ACP2E-4621 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
#### La validación telefónica de la dirección del cliente no funciona cuando no hay caracteres permitidos

El sistema devuelve un mensaje de error que indica que el teléfono no es válido.

_AC-16227 - [Problema de GitHub](https://github.com/magento/magento2/issues/40361) - [Contribución de código de GitHub](https://github.com/magento/magento2/pull/40416)_

#### Los objetos de sitio web y tienda devuelven ID como cadenas.

Se ha corregido un problema por el cual los ID de sitio web y de tienda se devolvían como cadenas en lugar de enteros. Esto resuelve los errores de tipo en modo estricto, lo que permite que EmailNotification::newAccount() y métodos similares funcionen correctamente.

_AC-16486: [problema de GitHub](https://github.com/magento/magento2/issues/40469)_

#### La validación de ciudad del cliente no funciona para caracteres no permitidos

Se ha corregido un problema en el cual las direcciones de los clientes se podían guardar con caracteres no válidos (como /, @, #, !) en el campo de la ciudad. Tras esta corrección, el sistema valida y rechaza correctamente las direcciones que contienen caracteres no permitidos.

_AC-16504 - [Problema de GitHub](https://github.com/magento/magento2/issues/40521) - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/57bad413)_

#### [Problema] solucionado: aumentar longitud de columna IP para compatibilidad con IPv6 en admin_user_session

Actualmente, la columna de IP en admin_user_session está limitada a 15 caracteres, lo que no es suficiente para las direcciones IPv6 (hasta 45 caracteres). Esta PR aumenta la longitud a 45 para garantizar la compatibilidad total con IPv6 y evitar el truncamiento de datos o errores cuando se utiliza IPv6.

_AC-16659 - [Problema de GitHub](https://github.com/magento/magento2/issues/40570) - [Contribución de código de GitHub](https://github.com/magento/magento2/pull/40563)_
...
#### La validación del nombre de ciudad acepta caracteres no permitidos (!&quot;#?)

Al introducir una ciudad en una dirección de cliente, la validación ahora permite una barra diagonal y rechaza correctamente caracteres no válidos como !, &quot;, # y ?.

_ACP2E-4527 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/f2fd9628)_

#### Validadores de direcciones que rompen el cliente existente después de actualizar a 2.4.8-p3

Anteriormente, antes de esta corrección, los números de teléfono modernos tenían los caracteres . o \ no se han validado correctamente. Después de aplicar esta corrección, los números de teléfono modernos contienen los caracteres . o \ ya están validados.

_ACP2E-4554 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### [El PHPSESSID de la nube] se cambió tras la solicitud de restablecimiento de contraseña y se borró el carro de compras actual

Antes de la corrección, al enviar el formulario de contraseña olvidada se destruía/regeneraba la sesión (se cambiaba el PHPSESSID) y se borraba el carro de compras de los invitados. Después de la corrección, al enviar el formulario de contraseña olvidada la sesión no se modifica y el carro de compras de invitados se conserva.

_ACP2E-4524 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### [Problema] Fix(admin): posición correcta del selector de fecha dentro de la diapositiva modal

Esta solicitud de extracción corrige un problema en el que el selector de fecha de Magento no se muestra correctamente dentro de los cuadros de diálogo modales de administración.
Por ejemplo, esto afectaba a la sección Precios avanzados al editar o crear un producto desde el panel de administración.

_AC-16378 - [Problema de GitHub](https://github.com/magento/magento2/issues/40468) - [Contribución de código de GitHub](https://github.com/magento/magento2/pull/40225)_

#### El valor FTP en la página del carro y en la página del producto es diferente para las mismas configuraciones

Se ha corregido un problema por el cual los valores de Impuesto sobre productos fijos (FPT) se mostraban de forma diferente en las páginas de productos y en las páginas del carro de compras debido a incoherencias en el redondeo. Tras esta corrección, los precios de FTP ahora son coherentes en todas las páginas del catálogo, el producto y el carro de compras, lo que elimina discrepancias.

_AC-16550 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/8391dbcc)_
...
_ACP2E-4337 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/31258bf6)_
...
#### No se puede actualizar la configuración del almacén en el Panel de administración

Anteriormente, la caché local, la caché obsoleta y Redis no se sincronizaban cuando Redis no estaba disponible. Los cambios de configuración realizados durante las interrupciones de Redis no se reflejaron correctamente después de que Redis se recuperara, lo que provocó que los valores antiguos persistieran. Esta corrección garantiza la sincronización correcta en todas las cachés, de modo que los valores guardados más recientes se conserven y sean visibles incluso cuando Redis esté caído.

_ACP2E-4447 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

#### La cuadrícula de archivo no se sincroniza con los datos de pedidos más recientes cuando la indexación de cuadrícula asincrónica está habilitada

La cuadrícula del archivo de pedidos de ventas ahora muestra el estado de pedido correcto con indexación asíncrona

_ACP2E-4493 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/f2fd9628)_

#### Atributo de producto Cambios de actualización masiva tipo de producto Virtual->Simple

Evita el &quot;¿Tiene esto un peso?&quot; los controles se activan antes de que se inserten los paneles de atributos de actualización masiva, lo que evita cambios de peso no deseados para los productos virtuales.

_ACP2E-4500 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

#### Superposición de texto en PDF de facturas de varias páginas cuando el nombre del producto y las opciones personalizadas son largos

Antes de la corrección, en los PDF de facturas, envíos, notas de abono y devoluciones de varias páginas, los nombres de producto largos con opciones personalizadas podrían superponerse con las columnas o artículos adyacentes después de los saltos de página, lo que haría ilegibles las secciones de artículos de línea.
Después de la corrección, los artículos de línea ahora fluyen correctamente entre páginas y los nombres/opciones largos se representan sin superposición en los PDF de factura, envío, nota de abono y devolución.

_ACP2E-4630 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/d8a248cd)_

#### El editor [Cloud] HugeRTE bloquea los emojis después de la actualización

Antes de la corrección, la validación de WYSIWYG/PageBuilder bloqueaba el contenido de emoji moderno de 4 bytes de forma incondicional debido a una regla de interfaz de usuario que se aplicaba de forma demasiado amplia, incluso en instalaciones en las que la ruta de almacenamiento real era segura para utf8mb4. Después de la corrección, la validación se decide en función de la ruta de persistencia real comprobando el conjunto de caracteres/intercalación de conexión DB activa junto con la intercalación de columna de contenido de destino, por lo que se permite el contenido seguro para utf8mb4 mientras que las rutas utf8/utf8mb3 permanecen protegidas.

_ACP2E-4675 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/c58a8ad0) - [Contribución de código de GitHub](https://github.com/magento/magento2-page-builder/commit/5fd20dbb)_
...
### IU de administración, catálogo, rendimiento

#### Rendimiento deficiente de la llamada gettree en la Galería multimedia

Se ha mejorado el rendimiento de la Galería de medios al cambiar la carga del árbol de directorios a la expansión de nodos bajo demanda en lugar de crear el árbol completo por adelantado, lo que reduce significativamente el tiempo de respuesta inicial de gettree en estructuras de directorio de medios grandes

_ACP2E-4605 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
### IU de administración, cliente/clientes

#### El botón Restablecer formulario de IU no funciona como se espera para el campo &quot;Asociar a compañía&quot; en la página de adición y edición del cliente

Se ha corregido un problema en el cual el botón Restablecer no restablecía correctamente el campo &quot;Asociar con la compañía&quot; en el formulario de adición o edición del cliente. El formulario ahora restablece todos los campos correctamente sin volver a cargar la página, restaurando el comportamiento esperado.

_AC-16364_

### IU de administración, importación/exportación

#### El archivo CSV de exportación está disponible para su descarga mientras que la exportación no ha finalizado

Antes de la corrección, los archivos de exportación de productos en cola se escribían directamente en su ubicación final en var/export, por lo que la cuadrícula de exportación de Administración podía mostrarlos y permitir la descarga antes de que finalizara la generación. Como resultado, los usuarios podían descargar archivos CSV vacíos o parcialmente generados, y los archivos no relacionados presentes en var/export también podían aparecer en la lista de exportación y ser descargables.
Después de la corrección, las exportaciones en cola se escriben en un archivo temporal y se publican en la ubicación de exportación final solo después de que la generación se complete correctamente. La cuadrícula de exportación de administración y la acción de descarga ahora muestran solo los archivos de exportación completados cuyo formato coincide con las opciones configuradas de Formato de archivo de exportación, lo que evita descargas parciales y excluye archivos no relacionados de la interfaz de usuario.

_ACP2E-4724 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_
...
### IU de administración, Pedido, Pagos

#### No se puede procesar el reembolso parcial - el cálculo de reembolso no coincide

El reembolso del pedido en línea ahora funciona correctamente. Anteriormente, se generaba el siguiente error: &quot;La puerta de enlace de PayPal rechaza la solicitud. Error interno&quot;.

_ACP2E-4615 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_

### IU de administración, rendimiento

#### Lentitud grave en el panel de administración de ensayo al guardar el producto

El guardado/edición del formulario del producto del administrador es más rápido para grandes conjuntos de atributos al reducir las costosas pasadas de validación del lado del cliente, al tiempo que se conserva el comportamiento de validación existente. Esto reduce las posibilidades de que la &quot;página no responda&quot; se detenga en la IU del administrador.

_ACP2E-4488 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/f2fd9628)_

### IU de administración, producto

#### [Cloud] RequireJS.mixins.js causa la carga de scripts duplicados para todos los módulos deps.

Antes de la corrección, algunos archivos JavaScript de tienda se podían solicitar y ejecutar dos veces, lo que provocaba cargas duplicadas intermitentes y un comportamiento inestable. Después de la corrección, las dependencias de JavaScript se cargan solo una vez, lo que elimina las solicitudes duplicadas y mantiene intacta la funcionalidad de mezcla existente.

_ACP2E-4626 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Problema de administración de entradas en el campo de fecha de caducidad de la cuenta de tarjeta regalo

Al crear o editar una cuenta de tarjeta de regalo en Administración, el campo Fecha de caducidad ahora se valida correctamente. Anteriormente, los valores introducidos manualmente que no coincidían con un formato de fecha válido se podían procesar incorrectamente cuando se guardaba la cuenta.
...
#### [Problema] Corrección de rendimiento para el trabajo cron analytics_collect_data de larga duración

Se ha optimizado el rendimiento del trabajo cron analytics_collect_data para bases de datos grandes al actualizar las consultas de validación de informes para utilizar LIMIT 1 en lugar de LIMIT 0. Esto evita la carga innecesaria de datos de tabla completa durante la validación y reduce significativamente el tiempo de ejecución. Sin impacto funcional, mejora totalmente compatible con versiones anteriores.

_AC-16639 - [Problema de GitHub](https://github.com/magento/magento2/issues/40590) - [Contribución de código de GitHub](https://github.com/magento/magento2/pull/40463)_

#### El informe de usuario de registro de acciones de administración no muestra los detalles del filtro que se utilizó al aplicar los filtros
...
#### Pico máximo de E/S de disco en nodos de servicio debido al trabajo cron aggregate_sales_report_order_data

Corrige el problema en el cual el informe de pedidos agregados diarios tarda una cantidad de tiempo excesiva en generarse para un gran volumen de pedidos, lo que provoca picos de E/S de disco y una degradación del rendimiento. Después de la corrección, el informe se genera a tiempo.

_ACP2E-4363 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

#### [NUBE] de degradación de rendimiento debido a la ejecución cron analytics_collect_data

Mejore el rendimiento relacionado con el trabajo cron de análisis.

_ACP2E-4496 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/f2fd9628)_
...
#### Continúe con Cierre de compra y Solicite un presupuesto que no esté visible en el carro de compras después de asignar un cliente a la empresa mientras se inicia sesión

Se ha corregido un problema por el cual, cuando se asigna un cliente a una empresa mientras se inicia sesión en la tienda, los botones &quot;Continuar con el cierre de compra&quot; y &quot;Solicitar presupuesto&quot; no eran visibles en la página del carro de compras. Después de esta corrección, ambos botones aparecen inmediatamente sin que sea necesario que el cliente cierre la sesión y vuelva a iniciarla.
...
#### [B2B] La página Mis presupuestos no muestra ningún presupuesto cuando algunos presupuestos contienen productos eliminados

Mi presupuesto ahora muestra las cotizaciones correctamente cuando algunas cotizaciones contienen productos eliminados.

_ACP2E-4608 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Varios cupones no funcionan como se espera para Google Pay

Se ha corregido un problema por el cual varios códigos de cupones no funcionaban según lo esperado en la hoja de pago de Google Pay Express. Anteriormente, la aplicación de un segundo código de cupón eliminaba incorrectamente el descuento del primer cupón y mostraba totales inexactos. La eliminación de cupones tampoco actualizaba correctamente la hoja de pago.
Ahora, los clientes pueden aplicar varios códigos de cupón en la hoja de pago Google Pay Express y todos los descuentos se reflejan con precisión.

_PAQUETE-3507_

#### Braintree SDK recibe una llamada en cada página para obtener el token del cliente, incluso si el mensaje &quot;Pagar más tarde&quot; está desactivado

El SDK de Braintree estaba realizando una llamada para recuperar el token del cliente en cada carga de página, incluso cuando el mensaje Pagar más tarde estaba desactivado. Esto resultaba en solicitudes innecesarias y posibles problemas de rendimiento.
El sistema ahora solo solicita el token de cliente de Braintree si están activados tanto el método de pago mediante PayPal como el mensaje &quot;Pagar más tarde&quot; para el carrito. Esto evita solicitudes de token innecesarias y mejora el rendimiento de carga de la página.

_PAQUETE-3508_

#### Dejar de procesar los archivos js y la plantilla de depósito de Braintree Payment methods en la sección &quot;Métodos de pago almacenados&quot; del área de la cuenta del cliente

Los archivos de JavaScript y de plantilla para los métodos de pago de Braintree se representaban en la sección &quot;Métodos de pago almacenados&quot; del área de cuenta de cliente, incluso cuando los métodos de pago y las configuraciones de almacenamiento de Braintree estaban desactivados. Esto provocaba errores innecesarios en la consola del explorador.
El sistema ahora comprueba si el método de pago Braintree y su configuración de almacenamiento en depósito están activados antes de procesar archivos y formularios relacionados. Solo cuando ambos están activados, las plantillas de depósito y los scripts aparecen en la sección &quot;Métodos de pago almacenados&quot;.

_PAQUETE-3509_

#### Problemas de compatibilidad de Apple Pay y Google Pay Third Party

Los clientes encontraban errores al intentar realizar pagos a través de Apple Pay o Google Pay mediante extensiones de pago de terceros (como Hyvä Checkout) o personalizaciones. En concreto, Apple Pay generaría un TypeError debido a la falta de un nombre de comerciante, y Google Pay también podría fallar según las interacciones de código personalizado.
Se han resuelto los problemas de compatibilidad con Apple Pay y Google Pay. El sistema ahora gestiona correctamente las extensiones y personalizaciones de cierre de compra de terceros, lo que garantiza que los valores de configuración necesarios estén presentes y se devuelvan correctamente.

_PAQUETE-3510_

#### Google Pay a través de Braintree lleva a una carga infinita durante el proceso de pago

Cuando Google Pay se activaba a través de Braintree, el proceso de pago y envío entraba en un estado de carga infinito después de seleccionar Google Pay como método de pago. Esto impedía que los clientes completaran sus pedidos, sin mensajes de error ni comentarios.
La integración de Google Pay mediante Braintree se ha corregido para garantizar que el flujo de pago se realice según lo esperado. Los clientes ahora pueden seleccionar Google Pay durante el proceso de pago, completar el proceso de pago y realizar pedidos correctamente.
...
#### El subtotal muestra 0 después de desprotegerse con varias direcciones y agregar una opción diferente del producto configurable

Se ha corregido un problema en el cual el subtotal del carro de compras se mostraba incorrectamente como 0 después de agregar una opción diferente de un producto configurable después del cierre de compra de varias direcciones. El subtotal ahora refleja correctamente el valor real del carro de compras.

_AC-14460 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/57bad413)_
...
#### [Problema] Llamar a RemoveItem en el carro en lugar de ItemRepository

Reemplaza las llamadas deleteById en CartItemRepository por removeItem en la instancia de carro de compras.
Esto garantiza que se activen los observadores esperados y que el elemento también se actualice en el objeto de carro de compras, en lugar de solo en la base de datos.

_AC-15963 - [Problema de GitHub](https://github.com/magento/magento2/issues/40255) - [Contribución de código de GitHub](https://github.com/magento/magento2/pull/40248)_
...
#### Descuento de regla de precio de carro que no funciona con condición de exclusión de SKU

Se ha corregido un problema por el cual las reglas de precios del carro de compras se aplicaban incorrectamente incluso cuando las SKU excluidas estaban presentes en el cálculo del subtotal. La lógica de descuento ahora ignora correctamente los artículos excluidos al evaluar las condiciones de las reglas.

_AC-16417 - [Problema de GitHub](https://github.com/magento/magento2/issues/40503) - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/8391dbcc)_
...
Antes de la corrección al cancelar la opción de multienvío, la dirección no se preseleccionaba al volver a multienvío. Ahora, la dirección predeterminada se reemplaza con una de las selecciones realizadas en la pantalla de envío múltiple.
...
#### cantidad que se muestra como 0 en la sección del carro de compras del cliente de administración al agregar productos PAQUETE  
...
_ACP2E-4245 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/cbca0396)_
...
#### Problema de [CLOUD] al aplicar una tarjeta regalo con Recaptcha v2 (&quot;No soy un robot&quot;)

Las tarjetas de regalo ahora se aplican correctamente cuando reCAPTCHA v2 (&quot;No soy un robot&quot;) está habilitado, después de una validación exitosa de reCAPTCHA.

_ACP2E-4410_

#### Se está creando una cotización nula al usar Iniciar sesión como cliente desde el administrador

Se ha resuelto un problema que provocaba que se creara una cotización nula durante el flujo &quot;Iniciar sesión como cliente&quot;.

_ACP2E-4472 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

#### Incoherencia en el comportamiento de los productos agrupados con el envío a tarifa plana y el envío gratuito

Antes de la corrección, el envío gratuito no se calculaba correctamente para los productos agrupados cuando se proporcionaba mediante reglas de descuento en el carro de compras. Después de la corrección, el envío gratuito se calcula correctamente para los productos agrupados.

_ACP2E-4536 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/c12a7510)_

#### El pedido no se puede realizar para productos con SKU numéricas

El sistema ya no genera un error al realizar un pedido de un producto con un SKU numérico.

_ACP2E-4669 - [Contribución de código de GitHub](https://github.com/magento/inventory/commit/83d11138)_

#### Las reglas de validación de Atributo de dirección del cliente (EAV) entran en conflicto con las reglas de validación codificadas.

Se ha mejorado la validación telefónica de direcciones de clientes para admitir valores de hasta 255 caracteres, alineando las comprobaciones del lado del servidor con los límites de la base de datos. La gestión de errores también se ha refinado para que los números de teléfono con exceso de longitud devuelvan un mensaje claro y específico de la longitud.

_ACP2E-4735 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### [Cupón] Error intermitente de entrada de cupones duplicados en la tabla quote_coupons

Se ha resuelto un error intermitente de clave duplicada en la tabla quote_coupons cuando se ejecutaban varias solicitudes de guardado de comillas o combinación de carros de compras al mismo tiempo.
...
_ACP2E-4266 - [Contribución de código de GitHub](https://github.com/magento/inventory/commit/ae1f272f)_
...
### Carro y cierre de compra, rendimiento

#### [TOYOTA] Problema de rendimiento con la clase Magento\Store\Model\System\Store

Mejora del rendimiento en relación con varias tiendas y sitios web.

_ACP2E-4491 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

### Carro y Pago, Precios, Impuestos

#### Los precios del paquete de productos muestran valores de impuestos y monedas incorrectos entre el PDP y el carro de compras en una configuración de varias monedas.

Los precios de los productos agrupados ahora se muestran correctamente entre las páginas de PDP y de cierre de compra.

_ACP2E-4673 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### [\Magento\ConfigurableProduct\Model\Product\Type\Configurable] error de PHP desconocido
...
El sistema ahora ordena Los productos más recientes de la base de datos (el que tiene el entity_id más alto) se muestran primero
...
#### El widget de lista de productos del catálogo Magento devuelve un recuento incorrecto

El widget de lista de productos del catálogo Adobe Commerce ahora devuelve el recuento total y la paginación correctos (por ejemplo, 9 elementos en todas las páginas según la configuración).

_AC-14541 - [Problema de GitHub](https://github.com/magento/magento2/issues/39863) - [Contribución de código de GitHub](https://github.com/magento/magento2/pull/40421)_
...
#### Meta tags auto generation: las variables no se pueden usar varias veces

La generación automática de palabras clave meta de producto ahora reemplaza todos los marcadores de posición en la máscara configurada (p. ej. `{{name}}, order {{name}}`), no solo la primera ocurrencia.

_AC-14626 - [Problema de GitHub](https://github.com/magento/magento2/issues/35670) - [Contribución de código de GitHub](https://github.com/magento/magento2/pull/40412)_
...
#### El ID de grupo de clientes de la empresa no se asigna al ID de grupo de clientes del administrador de la empresa cuando se cambia el administrador de la empresa

Al cambiar el administrador de una empresa en B2B, el ID de grupo de clientes del nuevo administrador de la empresa no se actualizaba para que coincidiera con el catálogo compartido asignado de la empresa. Esto provocaba que los precios de nivel y los permisos de categoría para el nuevo administrador se basaran en el grupo de clientes de la compañía anterior, lo que producía precios y permisos incorrectos.
El sistema ahora actualiza correctamente el ID de grupo de clientes del administrador de la empresa cuando se cambia el administrador. Esto garantiza que el nuevo administrador reciba los precios de nivel y los permisos de categoría correctos asociados al catálogo compartido de su compañía.

_AC-14897: [problema de GitHub](https://github.com/magento/magento2/issues/39964)_
...
#### Problema de desfase de existencias y sitio web de la alerta de existencias de productos para varios sitios web

Esta corrección incluye website_id y store_id de las tablas product_alert_stock y product_alert_price en la cláusula SELECT de recopilación, lo que garantiza que la cuadrícula de administración muestre el sitio web correcto en el que se suscribió cada alerta.

_AC-15044 - [Problema de GitHub](https://github.com/magento/magento2/issues/40027) - [Contribución de código de GitHub](https://github.com/magento/magento2/pull/40431)_
...
#### [Problema]: error al visitar la página de comparación sin elementos

Se corrige un error en el cual, al visitar la página de comparación de productos del catálogo sin elementos de comparación, se producía un error grave al garantizar que la acción de comparación gestione de forma segura las colecciones de elementos vacías en lugar de generar excepciones.

_AC-15746 - [Problema de GitHub](https://github.com/magento/magento2/issues/40205) - [Contribución de código de GitHub](https://github.com/magento/magento2/pull/40203)_
...
#### El correo electrónico de recogida en la tienda sigue utilizando métodos heredados

No hay ninguna descripción disponible.

_AC-16380 - [Problema de GitHub](https://github.com/magento/inventory/issues/3384) - [Contribución de código de GitHub](https://github.com/magento/inventory/pull/3385) - [Contribución de código de GitHub](https://github.com/magento/inventory/commit/b4aeda50)_
...
Se ha corregido un problema en el cual las opciones desplegables eliminadas se conservaban al crear atributos de producto. El sistema ahora elimina correctamente las opciones seleccionadas y refleja el recuento preciso después de guardar.

_AC-16437 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/57bad413)_
...
#### [NUBE] Comparar productos con un problema de recuento incorrecto para diferentes tiendas
...
#### [NUBE] dependencia de categoría circular

Antes de la corrección, se podían guardar categorías con dependencia circular. Después de la corrección, este comportamiento se evita mediante una regla de validación.

_ACP2E-4505 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/f2fd9628)_

#### La jerarquía de CMS no actualiza la dirección URL jerárquica cuando se cambia la clave URL de la página secundaria (2.4.8-p3)

Se ha corregido un problema que causaba que al cambiar la clave URL de una página CMS no se actualizara la URL jerárquica de la página (por ejemplo, /help/my-account seguía siendo la misma tras cambiar el nombre a my-account-2). La lógica de actualización de jerarquía ahora incluye correctamente el nodo de la página, por lo que request_url se actualiza y la nueva ruta (por ejemplo /help/my-account-2) funciona según lo esperado.

_ACP2E-4531_

#### El marcador de posición de imagen no se muestra según lo esperado en diferentes tiendas

Antes de la corrección, las imágenes de marcador de posición no se cargaban en el código de tienda cuando se insertaban en la dirección URL. Después de la corrección, los marcadores de posición de imagen distinguen entre ámbitos con o sin el código de almacén proporcionado en la dirección URL.

_ACP2E-4533 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_

#### [NUBE] de interbloqueo en la tabla magento_catalogpermissions_index_product. continuación

Antes de la corrección, la ejecución del reíndice de productos de Permisos de catálogo podía dejar sin cambios las filas de índice de permisos existentes, por lo que las concesiones de permisos de categorías actualizadas no se reflejaban de forma fiable en los productos.
Después de la corrección, el reíndice actualiza correctamente las filas de índice de permisos existentes, de modo que los cambios de permisos se aplican de forma coherente en el acceso a la tienda, la visibilidad de los precios y la disponibilidad del cierre de compra.

_ACP2E-4603_

#### El indexador de reglas de Target cron no elige productos habilitados solo en el ámbito de la vista de tienda

Antes de la corrección, el indexador de reglas de destino no recogía los productos que no estaban habilitados en el ámbito de administración. Ahora, después de la corrección, los productos se recogen si están habilitados en al menos un ámbito.
...
#### [Nube]: error que se muestra cuando el valor catalog_product_entity_int para attribute_type selecciona 0 o Nulo en los productos de graphql

Se ha corregido un problema en el cual la consulta de productos de GraphQL con acumulaciones devolvía un error con valores de atributo u opciones no válidos. La consulta ahora gestiona correctamente los datos no válidos y devuelve los resultados correctos.

_ACP2E-4529 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/f2fd9628)_
...
#### La estructura de carpetas de la Galería multimedia desaparece cuando el nombre de la imagen de categoría empieza por &quot;-&quot; (guión)

No hay ninguna descripción disponible.

_AC-16544: [problema de GitHub](https://github.com/magento/magento2/issues/40536)_

#### El error &quot;El bloque de CMS contiene contenido no válido&quot; se muestra al guardar el bloque de CMS &quot;Lista de eventos de catálogo&quot;

Se ha corregido un problema que causaba que, al guardar el bloque predeterminado &quot;Lista de eventos de catálogo&quot; de CMS, se mostrara el error &quot;El bloque de CMS contiene contenido no válido&quot;. Después de esta corrección, el bloque se puede guardar correctamente sin errores en el panel de administración.

_AC-16686 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/0c9a749b)_
...
#### [ADOBE STOCK] registros críticos en &quot;No se pudieron recuperar los resultados de los archivos de búsqueda de Adobe Stock&quot; aunque la integración esté deshabilitada.

El sistema ya no registra el error &quot;No se pudieron recuperar los resultados de los archivos de búsqueda de Adobe Stock&quot; cuando la integración de Adobe Stock está desactivada.

_ACP2E-4634_

#### Errores al crear páginas nuevas y al utilizar el Generador de páginas: error

Se ha corregido un problema en el cual las páginas de CMS no se guardaban al usar Page Builder.
...
_AC-14940 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/3e41a43b)_
...
_AC-14883 - [Problema de GitHub](https://github.com/magento/magento2/issues/39947) - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/3717e6cb) - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/d3ea191d)_
...
_AC-15446 - [Problema de GitHub](https://github.com/magento/magento2/issues/40170) - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/e9412b24)_
...
#### Módulo NewRelic: elimine las dependencias innecesarias

Elimina la dependencia innecesaria de magento/magento-composer-installer del módulo magento/module-new-relic-reporting para limpiar el acoplamiento no utilizado/estrecho en las dependencias

_AC-15945: [problema de GitHub](https://github.com/magento/magento2/issues/40243)_
...
#### Cron captcha_delete_expire_images no funciona después de la actualización de Magento 2.4.8

Antes de la corrección, las imágenes de captcha caducadas ya no se eliminaban automáticamente. Después de la corrección, las imágenes captcha caducadas se eliminan mediante la tarea cron correspondiente.

_ACP2E-4512 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

### Marco, Rendimiento

#### [NUBE] Lenta consulta de reconciliación MySQL en cuadrícula de ventas asíncrona cron - exploración de tabla completa, más de 20 s, ~14M filas examinadas

Se ha mejorado el rendimiento de la reconciliación asíncrona de la cuadrícula de ventas al cambiar la detección de ID faltantes a ventanas entity_id delimitadas con progresión basada en cursor, lo que reduce los análisis repetidos de tablas grandes en tiendas de gran volumen.

_ACP2E-4585 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_
...
Se ha revertido el cambio anterior que devolvía errores en un formato diferente. Ahora los posibles errores se devuelven de forma coherente, sin romper el esquema de GraphQL.
...
Antes de la corrección, la posición del nodo de error no proporcionaba una compatibilidad perfecta con las versiones 2.4.7 y 2.4.9. Ahora, después de la corrección, el nodo de error se coloca correctamente para dar cabida a ambas versiones.
...
#### AC-2.4.9: no se pueden buscar pedidos en la plantilla EDS

El tipo de entrada de la consulta de GraphQL guestOrder se ha actualizado a GuestOrderInformationInput en lugar de OrderInformationInput.

_LYNX-872_

#### [AC-2.4.9] La consulta del carro de compras devuelve un estado de disponibilidad incorrecto para los productos con el inventario de varias Source (MSI) y el valor de stock predeterminado es 0

Se ha resuelto un problema en el cual la API de carro de compras devolvía incorrectamente is_available: false para productos con un inventario suficiente en varias fuentes de inventario de Source (MSI).

_LYNX-918_

#### [AC-2.4.9] no puede establecer la dirección de envío/facturación de un cliente con setNegotiableQuoteShippingAddress/setNegotiableQuoteBillingAddress GQLs

Se ha expuesto el campo uid en la consulta GraphQL de la dirección del cliente para habilitar la configuración de las direcciones de envío y facturación en las ofertas negociables.

_LYNX-924_

#### [Lista de pedidos AC-2.4.9] | error interno del servidor

Se ha garantizado la estabilidad en los flujos de pedidos al devolver nulo para los productos comprados que faltan, lo que evita excepciones en el historial de pedidos y en los pedidos recientes.

_LYNX-937_

#### [AC-2.4.9] Alinear NegotiableQuoteBillingAddressInput con BillingAddressInput

&#39;
Se ha alineado NegotiableQuoteBillingAddressInput, BillingAddressInput, ShippingAddressInput y GiftRegistryShippingAddressInput para admitir el UID de dirección del cliente al dejar obsoleto el ID de dirección del cliente.
Se han introducido las mutaciones deleteCustomerAddressV2 y updateCustomerAddressV2 para admitir el UID de dirección del cliente y se han desaprobado las mutaciones deleteCustomerAddress y updateCustomerAddress existentes.
...
### GraphQL, Pedido, Precios

#### [Nube] La consulta SalesGraphQl customerOrders devuelve valores incorrectos para los campos de artículo de pedido

Corrige el problema en el que la consulta customerOrders de SalesGraphQl devolvía valores originales_price_included_tax y original_row_total_included_tax inflados cuando los precios de catálogo estaban establecidos en &quot;Impuesto incluido&quot; porque el impuesto se aplicó por segunda vez a precios que ya incluían impuestos.

_ACP2E-4762 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### CSV de precios avanzados, no se exporta el CSV de productos. OOM incluso con límite de memoria 4G

Antes de la corrección, las exportaciones completas de productos y precios avanzados podían fallar con un alto uso de memoria/OM en catálogos grandes, y la paginación de exportación de productos podía producir filas duplicadas cuando el tamaño de página dinámico cambiaba durante el procesamiento. Después de la corrección, las exportaciones se completan con un comportamiento de memoria estable mediante el procesamiento por lotes paginado, se eliminan las filas duplicadas de la superposición de paginación y el contenido de filas exportado permanece alineado con el resultado de línea de base.

_ACP2E-4587 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
#### El estado de venta del paquete no se actualiza cuando se cancela el pedido

La comerciabilidad del producto del paquete ahora se calcula correctamente después de cancelar el pedido.

_ACP2E-4481 - [Contribución de código de GitHub](https://github.com/magento/inventory/commit/96b77663)_

#### Magento permite las ventas en exceso cuando varios clientes realizan pedidos simultáneamente

Con MSI, varios clientes podrían realizar pedidos para el mismo producto al mismo tiempo y superar las existencias disponibles, lo que provoca una venta excesiva. Después de la corrección, solo se puede realizar un pedido correcto por producto cuando las desprotecciones se ejecutan simultáneamente, por lo que ya no se produce la sobreventa.

_ACP2E-4509 - [Contribución de código de GitHub](https://github.com/magento/inventory/commit/a33c60f2)_

#### Tiempos de espera de [CLOUD] si los clientes tienen más de 140 artículos en la cesta

Las consultas de bases de datos de inventario se han optimizado para cargar rápidamente los datos de inventario durante el cierre de compra. Esto elimina la necesidad de consultas individuales para cada SKU, lo que conduce a un aumento significativo del rendimiento para el cierre de compra con carros de compras grandes.

_ACP2E-4519 - [Contribución de código de GitHub](https://github.com/magento/inventory/commit/40858072)_

### Lealtad

#### [CLOUD] getCustomerRewardPoints emite una excepción cuando el cliente no tiene puntos

Los puntos de recompensa del cliente se inician correctamente cuando se crean mediante el administrador.

_ACP2E-4403 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
#### AddComment de factura puede generar un error cuando se llama primero a Invoice getComments

Esta PR resuelve un error crítico por el que la llamada a $invoice->getComments() antes de $invoice->addComment() provocó un error grave &quot;Llamada a una función de miembro addItem() en la matriz&quot;. La corrección implementa la comprobación de tipos y la conversión adecuadas entre los tipos de matriz y Colección en los métodos de comentario del modelo de factura, lo que garantiza que ambos métodos se puedan llamar en cualquier orden sin errores y mantiene la compatibilidad con versiones anteriores.

_AC-14848 - [Problema de GitHub](https://github.com/magento/magento2/issues/39884) - [Contribución de código de GitHub](https://github.com/magento/magento2/pull/40428)_
...
#### Falta el país en la columna &quot;Dirección de envío&quot; de la cuadrícula Ventas->Pedidos

Se ha corregido un problema en el cual la columna de dirección de envío de la cuadrícula de administración de pedidos no mostraba el país de los pedidos internacionales. La dirección ahora incluye información del país, mejorando la visibilidad y la facilidad de uso del pedido.

_AC-16256 - [Problema de GitHub](https://github.com/magento/magento2/issues/40403) - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/3e41a43b)_

#### El consumidor de pedidos asincrónicos rechaza pedidos con actualización de existencias diferida: NoSuchEntityException en CartManagementPlugin::getActive() (oferta inactiva)

Se ha corregido un problema crítico por el que fallaba el cierre de compra asincrónico con actualización de existencias diferida para pedidos de invitados. Anteriormente, el consumidor arrojaba una NoSuchEntityException debido a las comillas inactivas, lo que provocaba que los pedidos se marcaran como Rechazado en lugar de Pendiente. Tras esta corrección, el consumidor procesa correctamente las ofertas inactivas, mueve los pedidos de Recibido a Pendiente y ajusta las cantidades vendibles según lo esperado. La prueba MFTF AsyncOrderWithAsyncStockReservationTest ahora pasa.

_AC-16680 - [Contribución de código de GitHub](https://github.com/magento/inventory/commit/d3b2ef0b)_
...
#### GraphQL cancelOrder no cancela los pedidos totalmente pagados con tarjeta regalo

Antes de la corrección, un pedido que se había pagado completamente a través de una tarjeta regalo no pasaba automáticamente al estado &quot;cerrado&quot; cuando se llamaba a través de una mutación de GraphQL. Ahora, después de la corrección, el pedido pasa al estado cerrado cuando se cancela a través de GraphQL.

_ACP2E-4455 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

#### El uso del cupón no se revierte tras la cancelación/rechazo del pedido

Al cancelar un pedido, el uso del cupón aplicado se restablece ahora correctamente incluso si se ha modificado la configuración del estado del pedido. Esto podía hacer que los cupones permanecieran marcados como utilizados después de cancelar un pedido cuando la configuración del estado del pedido personalizado estaba establecida.
...
#### Reglas de precio del carro de compras basadas en el retraso de segmentos de clientes para usuarios registrados

Se ha corregido un problema en el cual las reglas de precios de carro de compras basadas en segmentos de clientes no se aplicaban inmediatamente a los usuarios registrados. El descuento ahora se aplica correctamente al añadir un producto apto al carro de compras sin requerir una actualización del token.

_LYNX-814_

#### GQL: el campo de cantidad de la interfaz de producto no devuelve una cantidad vendible

Se ha resuelto un problema de GraphQL en el que el campo de cantidad de la interfaz de producto no devolvía la cantidad vendible.

_LYNX-816_

#### No se puede devolver nulo para el campo que no admite valores NULL &quot;SelectedShippingMethod.carrier_code&quot;

Se ha corregido un problema en el cual al seleccionar el segundo método de envío durante el cierre de compra con una dirección de EE. UU., se producía el error No se puede devolver nulo para el campo que no admite valores NULL &quot;SelectedShippingMethod.carrier_code&quot;. Esta corrección garantiza una navegación fluida hacia el cierre de compra sin activar errores internos del servidor.

_LYNX-817_

#### [AC-2.4.9] addProductsToCartMutation devuelve 200 si hay error

Se ha introducido un nuevo código de error, REQUIRED_PARAMETER_MISSING, para gestionar los errores del usuario cuando las opciones de productos configurables no están seleccionadas durante la adición al carro de compras.

_LYNX-884_

#### [AC-2.4.9] Error al solicitar el campo CartItem.not_available_message o is_available cuando la comprobación del inventario del carro de compras está deshabilitada

Se corrigió un error al acceder a not_available_message o is_available en CartItem cuando se desactivó la comprobación de inventario del carro de compras.
...
#### Trabajo de cron atascado debido a OOM - solicitud para revisar innodb_buffer_pool_size y PHP memory_limit para cron

Se ha mejorado el procesamiento de transacciones de pago

_ACP2E-4601 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
_ACP2E-4610 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_

#### Último nivel: las subcategorías muestran el recuento de productos cero en el árbol de categorías de administración

Antes de la corrección, las categorías de hojas no incorporaban el recuento de productos cuando se mostraban en el árbol de categorías del área de administrador. Después de la corrección, el recuento de productos se muestra correctamente para cada hoja de categoría.

_ACP2E-4689 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/d8a248cd)_

#### Rendimiento de consulta lento en la tabla magento_premio_history debido a sus grandes datos

Se ha corregido el problema por el cual el trabajo cron de caducidad de puntos de recompensa se realizaba lentamente en tablas grandes de magento_recompensa_history. Anteriormente, la consulta utilizada por la caducidad de puntos programados carecía de índices de base de datos compuestos, lo que provocaba análisis de tabla completos en tablas con millones de registros.
...
#### Pedido o filtro por precio que no funciona para los productos del paquete sin existencias

Cuando la opción &quot;Mostrar productos sin existencias&quot; está activada, la página de lista de productos ahora filtra y ordena correctamente los productos de paquete sin existencias por precio.

_ACP2E-4475 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/f2fd9628) - [Contribución de código de GitHub](https://github.com/magento/inventory/commit/a33c60f2)_
...
#### Caracteres de escape innecesarios en ProductInterface

El sistema ahora devuelve `>` sin escape en el nombre en la respuesta de GraphQL.

_AC-15494 - [Problema de GitHub](https://github.com/magento/magento2/issues/40178) - [Contribución de código de GitHub](https://github.com/magento/magento2/pull/40423)_
...
#### Reembolso con cantidad negativa siempre reembolsar descuento
...
#### El indexador incremental de reglas de destino no elige productos deshabilitados

La indexación incremental de reglas de Target ahora responde cuando un producto está habilitado o deshabilitado, lo que garantiza la actualización de las recomendaciones de venta cruzada/ventas adicionales/relacionadas sin una reindexación completa.

_ACP2E-4402_

#### La segmentación de clientes no funciona correctamente con la API de REST

Los segmentos de clientes basados en el recuento de pedidos ahora se actualizan correctamente cuando los pedidos se realizan mediante la API de REST. Anteriormente, la pertenencia al segmento no se actualizaba para pedidos de API porque el observador dependía de la sesión del cliente, que no estaba disponible en las solicitudes de API.

_ACP2E-4590_

#### No se puede crear la regla de precio del carro de compras con la condición de acción &quot;Categoría (solo para niños)&quot; mediante la API de REST

Corrige el problema en el cual un ámbito de atributo de condición de regla de precio del carro de compras, como Categoría (solo principal) y Categoría (solo secundaria), no se exponía cuando se recuperaban o actualizaban reglas a través de la API de REST.

_ACP2E-4653 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/d8a248cd)_

#### Las reglas de precios del carro de compras para el envío gratuito no funcionan como se esperaba para los productos agrupados

Manejo mejorado del envío gratuito

_ACP2E-4720 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_

### Devuelve

#### Problema con la selección de opciones simple al devolver productos agrupados

Anteriormente, antes de que se implementara esta corrección, para los productos agrupados con la opción de enviar artículos por separado para las devoluciones, la función &quot;Seleccionar artículos&quot; solo abría el bloque emergente por primera vez. Después de seleccionar o cerrar el bloque emergente, no lo abría cada vez que se llamaba a la función &quot;Seleccionar elementos&quot;. Sin embargo, después de aplicar esta corrección, el problema se ha resuelto y la función ahora funciona según lo previsto.
...
#### Faltan caracteres de transliteración

El sistema ahora gestiona correctamente la transliteración de los caracteres que faltan

_AC-16626 - [Problema de GitHub](https://github.com/magento/magento2/issues/40580) - [Contribución de código de GitHub](https://github.com/magento/magento2/pull/40581)_
...
Antes de la corrección, los archivos agrupados o combinados generados no se añadían a la lista de hash de la SRI. Ahora, los archivos se están agregando correctamente a los hash de la SRI.
...
#### AC-15210 no parece completa. Se requiere la API REST de USPS en menos de un mes.

La integración de la API REST de USPS en Adobe Commerce (AC-15210) estaba incompleta. Los problemas clave incluían la falta de información de seguimiento, la pérdida de la configuración de Métodos permitidos al cambiar tipos de API, solicitudes excesivas que arriesgan límites de cuota y falta de protección contra errores de límite de cuota &quot;429&quot;. Si se superaba la cuota, las tarifas de envío no se mostraban a los clientes.
La integración de la API REST de USPS se ha mejorado para:
- Proporcione la información de seguimiento adecuada para los paquetes enviados.
- Conservar la configuración de los métodos permitidos al cambiar entre las herramientas WEB de USPS y las API de REST.
- Evite solicitudes innecesarias a la API de USPS, lo que reduce el riesgo de alcanzar los límites de cuotas.
- Controle correctamente los errores de límite de cuota &quot;429&quot;, lo que garantiza que las tarifas de envío permanezcan disponibles para los clientes.

_AC-16577 - [Problema de GitHub](https://github.com/magento/magento2/issues/40394) - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/15a9362d)_
...
#### El método de envío de la API REST de USPS no se muestra en el cierre de compra de algunos productos

Los métodos de envío de la API REST de USPS ya están disponibles para los productos que se encuentran en proceso de pago.

_ACP2E-4556 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_
...
Se ha corregido un problema en el cual los cambios en las reglas de precios de catálogo a través de actualizaciones de ensayo no se reflejaban de forma coherente en el carro de compras. Después de esta corrección, cuando se aplica una actualización de regla de precios programada, los precios de los productos se actualizan correctamente en todas las secciones del carro de compras (bloque central y bloque de resumen).

_AC-16530 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/57bad413)_
...
#### Problema en la programación de precios especiales

Antes de la corrección, el precio especial desde la fecha no se guardaba correctamente cada vez que se guardaba una actualización de ensayo. Ahora, después de la corrección, los precios especiales correspondientes desde/hasta las fechas se correlacionan con las fechas de inicio y finalización de la actualización de ensayo.

_ACP2E-4433 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/f2fd9628)_
...
La conversión del precio dinámico del producto del paquete excluyendo el cálculo de impuestos para el artículo de oferta funciona correctamente.

_ACP2E-4411 - [Contribución de código de GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### [Problema] SwiftOtter-SOP-348 Habilitar caché de configuración compilada para la ejecución de pruebas

Mejora el rendimiento de las pruebas de integración al habilitar la caché compilation_config durante la ejecución de las pruebas, reduciendo el uso de CPU y el tiempo de ejecución.

_AC-16018 - [Problema de GitHub](https://github.com/magento/magento2/issues/40253) - [Contribución de código de GitHub](https://github.com/magento/magento2/pull/40239)_
