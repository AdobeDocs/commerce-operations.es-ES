...
Hemos corregido 253 problemas en el código principal de Adobe Commerce 2.4.8. A continuación, se describe un subconjunto de los problemas corregidos que se incluyen en esta versión.
...
### IU de administración, actualizaciones: actualizar herramienta de compatibilidad

* _AC-12829_: el inicio de sesión del administrador con la funcionalidad OTP se rompió con la actualización 127 de Chrome
...
* _AC-12124_: [Error aleatorio] La biblioteca de Fotorama no está cargada
...
* _AC-11810_: Magento 2.4.6-p4 Pedido API Simple Artículo sin precio
...
* _AC-5969_: AlertProcessor - Argument #2 ($storeId) debe ser de tipo int, se ha proporcionado una cadena
   ...
   * _Contribución de código de GitHub_: <https://github.com/magento/magento2/commit/0574ac23>
* _AC-12880_: todos los paquetes de extensión generados diariamente - No generan informe de error
   * _Nota de corrección_: el informe de error debe generarse sin errores
...
* _AC-12669_: la afirmación de reproducción de vídeos de Vimeo/YouTube falla en las pruebas de Page Builder
...
* _AC-11806_: No se puede actualizar el error del Magento en SchemaBuilder.php en la línea: 253
   * _Problema de GitHub_: <https://github.com/magento/magento2/issues/38592>
