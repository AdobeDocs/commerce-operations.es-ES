...
Hemos corregido 279 problemas en el código principal de Adobe Commerce 2.4.8. A continuación, se describe un subconjunto de los problemas corregidos que se incluyen en esta versión.
...
* _AC-12268_:
   * _Nota de corrección_: investigue el problema de rendimiento después de actualizar las dependencias del Compositor de sistemas de archivos/liga a la última versión
...
* _AC-12715_:
   * _Nota de corrección_: investigue las dependencias del Compositor de láminas actualizando a la versión más reciente
