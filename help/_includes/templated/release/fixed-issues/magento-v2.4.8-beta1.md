...
Hemos corregido 221 problemas en el código principal de Magento Open Source 2.4.8. A continuación, se describe un subconjunto de los problemas corregidos que se incluyen en esta versión.
...
* _AC-9922_: Error CSP de Google Analytics https://region1.analytics.google.com
   * _Nota de corrección_: El sistema ahora permite correctamente las conexiones a &#39;https://region1.analytics.google.com&#39; cuando los Google Analytics están habilitados, lo que evita errores de la Política de seguridad de contenido (CSP). Anteriormente, habilitar a los Google Analytics y ver el sitio web desde la UE resultaba en errores de la consola CSP debido a la negativa a conectarse a &quot;https://region1.analytics.google.com&#39;&quot;.
...
* _AC-9712_: Diferencia en menos compilación entre php y nodejs library (grunt) con expresiones `calc` complicadas
   * _Nota de corrección_: Corrija la diferencia en menos compilación entre php y nodejs library (grunt)
...
* _AC-8358_: [Problema] Quitar etiqueta `@author` prohibida
   ...
   * _Problema de GitHub_: <https://github.com/magento/magento2/issues/37264>
   * _Contribución de código de GitHub_: <https://github.com/magento/magento2/pull/37014>
* _AC-8360_: [Problema] Quitar etiqueta `@author` prohibida
   * _Nota de corrección_: El sistema ahora se adhiere a los estándares de codificación eliminando la etiqueta `@author` prohibida de ciertos módulos, lo que mejora la calidad general del código. Anteriormente, la presencia de esta etiqueta en algunos módulos infringía los estándares de codificación establecidos.
   * _Problema de GitHub_: <https://github.com/magento/magento2/issues/37261>
   * _Contribución de código de GitHub_: <https://github.com/magento/magento2/pull/37011>
* _AC-8361_: [Problema] Quitar etiqueta `@author` prohibida
   ...
   * _Problema de GitHub_: <https://github.com/magento/magento2/issues/37260>
   * _Contribución de código de GitHub_: <https://github.com/magento/magento2/pull/37010>
* _AC-8400_: [Problema] Quitar etiqueta `@author` prohibida
   * _Nota de corrección_: El sistema ahora se adhiere a los estándares de codificación eliminando la etiqueta `@author` prohibida de ciertos módulos, lo que mejora la calidad general del código. Anteriormente, la presencia de esta etiqueta en algunos módulos infringía los estándares de codificación establecidos.
   * _Problema de GitHub_: <https://github.com/magento/magento2/issues/37254>
   * _Contribución de código de GitHub_: <https://github.com/magento/magento2/pull/37004>
...
* _AC-8714_: Barniz 7.3 - Los vínculos de subcategorías/opciones de la categoría predeterminada no se muestran en la página principal de la tienda
...
* _ACP2E-3002_: [CLOUD] no puede deshabilitar el envío de correos electrónicos desde la interfaz de usuario del administrador como muestran los documentos de desarrolladores
   ...
   * _Contribución de código de GitHub_: <https://github.com/magento/magento2/commit/c8931218>
* _AC-12462_: no se puede cambiar el estado personalizado intermedio en el administrador mediante el formulario de agregar comentario
   * _Nota de corrección_: El sistema ahora actualiza correctamente el estado del pedido a &quot;Listo para recoger&quot; cuando se cambia del formulario &quot;Agregar comentario&quot; en el panel de administración, lo que garantiza un seguimiento preciso del progreso del pedido. Anteriormente, el estado del pedido permanecía como &quot;Enviado&quot; incluso después de intentar cambiarlo a &quot;Listo para recoger&quot; a través del formulario &quot;Agregar comentario&quot;.
   * _Problema de GitHub_: <https://github.com/magento/magento2/issues/38917>
   * _Contribución de código de GitHub_: <https://github.com/magento/magento2/pull/38923>
...
* _AC-12128_: vulnerabilidad de seguridad [Cloud] Prototype.js CVE-2020-27511
   * _Nota de corrección_: la vulnerabilidad de seguridad CVE-2020-27511 debe resolverse
   * _Contribución de código de GitHub_: <https://github.com/magento/magento2/commit/de4dfb8e>
