...
* _AC-12128_:
   * _Nota de corrección_: [Vulnerabilidad de seguridad de Cloud] Prototype.js CVE-2020-27511
   * _Problema de GitHub_: &lt;<https://github.com/magento/magento2/commit/de4dfb8e>>
   * _Contribución de código de GitHub_: debe resolverse la vulnerabilidad de seguridad CVE-2020-27511
...
* _AC-12950_: Actualice tinymce 7.3.0 en composer.json y elimínelo de los archivos de tinymce 7
   * _Nota de corrección_: convierta TinyMCE 7.x en una versión compatible con Adobe Commerce 2.4.8-beta1
   * _Contribución de código de GitHub_: &lt;https://github.com/magento/magento2/ (interno, sin combinar)>
