...
La siguiente documentación de referencia se genera a partir de las `composer.lock` y cubre los paquetes necesarios incluidos en Adobe Commerce 2.4.6-beta2.

## Dependencias

`magento/product-enterprise-edition 2.4.6-beta2` tiene las siguientes dependencias:
...
<table>
  ...
  <tr>
    <td>
      <a href="https://github.com/twigphp/Twig.git">ramita</a>
    </td>
    <td>biblioteca</td>
    <td>Twig, el lenguaje de plantilla flexible, rápido y seguro para PHP</td>
  </tr>
  </tbody>
</table>
