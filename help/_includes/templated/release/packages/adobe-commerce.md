...
La siguiente documentación de referencia se genera a partir del archivo `composer.lock` y abarca los paquetes necesarios incluidos en Adobe Commerce 2.4.9.

## Dependencias

`magento/product-enterprise-edition 2.4.9` tiene las dependencias siguientes:
...
- [magento/module-aws-s3-gif-card-import-export](https://developer.adobe.com/commerce/php/module-reference/module-aws-s3-gift-card-import-export): 100.4.6
...
- [magento/module-checkout-address-search-gif-registry](https://developer.adobe.com/commerce/php/module-reference/module-checkout-address-search-gift-registry): 100.4.5
...
- [cálculo total aplazado de magento/módulo](https://developer.adobe.com/commerce/php/module-reference/module-deferred-total-calculating): 100.4.4
...
- [tarjeta regalo de módulo/magento](https://developer.adobe.com/commerce/php/module-reference/module-gift-card): 101.3.9
- [cuenta-tarjeta-regalo-módulo/magento](https://developer.adobe.com/commerce/php/module-reference/module-gift-card-account): 101.2.9
- [magento/module-gif-card-account-graph-ql](https://developer.adobe.com/commerce/php/module-reference/module-gift-card-account-graph-ql): 100.4.7
- [magento/module-gif-card-graph-ql](https://developer.adobe.com/commerce/php/module-reference/module-gift-card-graph-ql): 100.4.9
- [magento/module-gif-card-import-export](https://developer.adobe.com/commerce/php/module-reference/module-gift-card-import-export): 100.4.6
- [magento/module-gif-card-staging](https://developer.adobe.com/commerce/php/module-reference/module-gift-card-staging): 100.4.6
- [magento/module-gif-message-staging](https://developer.adobe.com/commerce/php/module-reference/module-gift-message-staging): 100.4.6
- [magento/module-gif-register](https://developer.adobe.com/commerce/php/module-reference/module-gift-registry): 101.2.9
- [magento/module-gif-register-graph-ql](https://developer.adobe.com/commerce/php/module-reference/module-gift-registry-graph-ql): 100.4.5
- [envoltorio para regalos de magento/módulo](https://developer.adobe.com/commerce/php/module-reference/module-gift-wrapping): 101.2.8
- [magento/module-gif-wrapping-graph-ql](https://developer.adobe.com/commerce/php/module-reference/module-gift-wrapping-graph-ql): 100.4.6
- [magento/module-gif-wrapping-staging](https://developer.adobe.com/commerce/php/module-reference/module-gift-wrapping-staging): 100.4.6
...
- [magento/module-agruped-product-staging](https://developer.adobe.com/commerce/php/module-reference/module-grouped-product-staging): 100.4.7
...
- [magento/module-login-as-customer-website-constraint](https://developer.adobe.com/commerce/php/module-reference/module-login-as-customer-website-restriction): 100.4.7
...
- [magento/module-quote-gif-card-options](https://developer.adobe.com/commerce/php/module-reference/module-quote-gift-card-options): 100.4.6
...
- [magento/module-premio](https://developer.adobe.com/commerce/php/module-reference/module-reward): 101.2.9
- [magento/module-premio-graph-ql](https://developer.adobe.com/commerce/php/module-reference/module-reward-graph-ql): 100.4.8
- [magento/module-recompensa-staging](https://developer.adobe.com/commerce/php/module-reference/module-reward-staging): 100.4.6
...
- [magento/module-scale-checkout](https://developer.adobe.com/commerce/php/module-reference/module-scalable-checkout): 100.4.8
- [magento/module-scale-inventory](https://developer.adobe.com/commerce/php/module-reference/module-scalable-inventory): 100.4.7
- [magento/module-scale-oms](https://developer.adobe.com/commerce/php/module-reference/module-scalable-oms): 100.4.7
...
- [magento/module-website-constraint](https://developer.adobe.com/commerce/php/module-reference/module-website-restriction): 100.4.8
- [magento/module-weee-staging](https://developer.adobe.com/commerce/php/module-reference/module-weee-staging): 100.4.6
- [magento/module-wishlist-gif-card](https://developer.adobe.com/commerce/php/module-reference/module-wishlist-gift-card): 100.4.5
- [magento/module-wishlist-gif-graph-ql](https://developer.adobe.com/commerce/php/module-reference/module-wishlist-gift-card-graph-ql): 100.4.5
...
<table>
  ...
  <tr>
    <td>
      <a href="https://github.com/brick/phonenumber">número de ladrillo/teléfono</a>
    </td>
    <td>Biblioteca</td>
  ...
  <tr>
    <td>
      <a href="https://github.com/symfony/cache-contracts">contratos de Symfony/cache</a>
    </td>
    <td>Biblioteca</td>
