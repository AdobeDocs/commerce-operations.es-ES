...
La siguiente documentación de referencia se genera a partir de las `composer.lock` y cubre los paquetes necesarios incluidos en Adobe Commerce 2.4.7-beta2.

## Dependencias

`magento/product-enterprise-edition 2.4.7-beta2` tiene las siguientes dependencias:
