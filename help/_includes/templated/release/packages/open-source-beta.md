...
La siguiente documentación de referencia se genera a partir de las `composer.lock` y cubre los paquetes necesarios incluidos en el Magento Open Source 2.4.7-beta1.

## Dependencias

`magento/product-community-edition 2.4.7-beta1` tiene las siguientes dependencias:
