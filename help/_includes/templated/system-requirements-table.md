...
>[!NOTE]
>
>Las versiones 2.4.4 y 2.4.5 soportan MySQL 8.0.0 a 8.0.28 solamente.
...
<table style="table-layout:auto">
  ...
  <tbody>
    ...
    <tr>
      <td><span class="uicontrol">[!DNL AWS Aurora (MySQL)]</span></td>
      <td>
            8.0.mysql_aurora.3.08 o la última disponible
      </td>
      <td>
            8,0
      </td>
