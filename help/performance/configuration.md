...
>[!INFO]
>
>La ficha **[!UICONTROL Developer]** y las opciones solo están disponibles en [modo de desarrollador](../configuration/cli/set-mode.md). El [Adobe [!DNL Commerce] en la infraestructura en la nube](https://devdocs.magento.com/cloud/requirements/cloud-requirements.html#cloud-req-test) no admite el modo `Developer`.
...
Los comerciantes que tienen un gran número de [segmentos de clientes](https://docs.magento.com/user-guide/marketing/customer-segments.html) pueden experimentar una degradación significativa del rendimiento con las acciones de los clientes, como el inicio de sesión de clientes y la adición de productos al carro de compras.
